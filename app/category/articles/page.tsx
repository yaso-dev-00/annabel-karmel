...
const secondPageArticles: ListingArticle[] = [
  ...
  },
  {
    ...
    heroImage:
      '/articles/annabels-top-10-burger-recipes/annabels-beef-burgers.jpg',
  ...
  },
  {
    ...
    heroImage:
      '/articles/10-quick-easy-puff-pastry-recipes/apple-cinnamon-twists.jpg',
  ...
  },
  {
    ...
    heroImage:
      '/articles/10-meals-you-can-make-with-leftovers/strata-with-cheese-bacon-eggs-tomatoes.png',
  ...
  },
  {
    ...
    heroImage:
      '/articles/what-to-do-when-your-baby-is-sick/shutterstock_1089455099-scaled-optimized.jpg',
  ...
  },
  {
    ...
    heroImage:
      '/articles/halloween-kids-party-recipes/monster-burgers-food.jpg',
...
const thirdPageArticles: ListingArticle[] = [
  ...
  },
  {
    ...
    heroImage:
      '/articles/10-healthy-nutritious-lunchbox-ideas/cheese-cherry-tomato-muffins.jpg',
  ...
  },
  {
    ...
    heroImage:
      '/articles/pasta-recipes-for-baby/babys-first-bolognese-sauce.jpg',
  ...
  },
  {
    ...
    heroImage:
      '/articles/annabels-top-10-summer-baby-purees/blueberry-pear-banana-puree.jpg',
  ...
  },
  {
    ...
    heroImage:
      '/articles/what-spices-can-you-give-to-your-baby/how-to-introduce-spices.jpg',
  ...
  },
  {
    ...
    heroImage:
      '/articles/10-easy-bbq-recipes-to-try-this-summer/chicken-on-the-griddle.jpg',
    heroAlt: 'BBQ recipes',
  ...
  },
  {
    ...
    heroImage:
      '/articles/zero-salt-family-recipes/leek-mushroom-puff-pastry-pie.jpg',
...
const fourthPageArticles: ListingArticle[] = [
  {
    ...
    heroImage:
      '/articles/annabels-top-10-finger-food-recipes/broccoli-chicken-potato-bites.png',
  ...
  },
  {
    ...
    heroImage:
      '/articles/meatless-iron-rich-purees/banana-avocado-blueberry-puree.jpg',
  ...
  },
  {
    ...
    heroImage:
      '/articles/perfect-pasta-dishes-for-baby-toddler-family/annabels-mighty-mac-n-cheese.jpg',
...
const fifthPageArticles: ListingArticle[] = [
  ...
  },
  {
    ...
    heroImage:
      '/articles/weaning-equipment-getting-kitchen-ready-weaning/kitchen-essentials.jpg',
...
export default async function ArticlesPage({
  ...
  const pageSize = 10;
  const curatedPages = Object.keys(curatedPageArticles).map((key) =>
  ...
  const visibleArticles =
    curatedPageArticles[currentPage] ?? defaultVisibleArticles;
      ...
      <main className="bg-white">
        <section className="mx-auto w-full max-w-[1200px] px-4 pb-10 pt-10 text-center sm:px-6 md:pt-14 lg:px-8">
          ...
          <p className="mx-auto mt-7  [font-family:var(--font-montserrat)] text-[22px] leading-[1.55] text-[#514a52] md:text-[19px]">
            All the latest news, views and information from the world of Annabel
            Karmel, including articles of interest for mums, dads and the whole
            family.
          </p>
        </section>
          ...
          <article className="overflow-hidden border border-[#e8e1e3] bg-[#f4eef0]">
            <div className="grid grid-cols-1 md:grid-cols-[1.95fr_1fr]">
              <div className="p-6 md:p-8">
                ...
                >
                  <span className="text-[18px] text-white md:text-[20px]">
        ...
        <section
          id="articles-list"
          className="mx-auto w-full max-w-[1120px] scroll-mt-[120px] px-4 pb-16 pt-6 sm:px-6 lg:px-8"
        >
            ...
            {visibleArticles.map((article) => (
              ...
              >
                ...
                <div>
                  ...
                  >
                    <span className="text-[15px] text-white md:text-[18px]">
                      Read More
                    </span>
                  </Link>
                </div>
