...
const recipes = [
  ...
  },
  {
    ...
    image:
      '/articles/pasta-recipes-for-baby/roasted-vegetables-baby-pasta-shells.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/pasta-recipes-for-baby/pasta-shells-tomato-mascarpone.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/pasta-recipes-for-baby/pasta-tomato-sweet-potato-cheese.jpg',
    excerpt:
    ...
    <>
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          ...
          <p className={`${styles.intro} md:text-left text-center`}>
            But it's not just for adults, pasta is a fantastic weaning food and
            a brilliant way to introduce texture to your little one.
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            It's such a versatile food, you can add to soups, serve hot or cold,
            dress up or down however you please - the pastabilities are endless!
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            These are my top 10 baby pasta recipes that definitely pasta the
            taste test!
          </p>
