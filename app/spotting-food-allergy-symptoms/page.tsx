...
export const metadata: Metadata = {
  title:
    'Spotting food allergy symptoms | Nutrition & Allergies | Annabel Karmel',
  description:
...
const symptoms: { category: string; description: string }[] = [
  {
    category: 'Eyes',
    description:
      'Itchy, watery, prickly, red, swollen and dark areas under the eyes',
  },
  {
        ...
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[16px] sm:px-[12px] md:mt-[40px] md:px-[14px] md:pt-[20px]">
          <div className="mx-auto ">
            ...
            <p className={`${styles.bodyText} ${styles.helplineText}`}>
              For further information and advice contact the Allergy UK Helpline
              on{' '}
