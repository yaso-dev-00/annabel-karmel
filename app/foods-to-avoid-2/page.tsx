...
const avoidSections = [
  {
    title: 'Honey',
    body: 'This is off limits until 12 months as it comes with a very small chance that it may contain the food poisoning bacteria botulism. Botulism is a very rare condition but one that makes your baby very sick and can be life-threatening.',
  },
  {
    title: 'Rice milk',
    body: "Although it's unlikely that you'll be offering your baby rice milk in large quantities, you need to be careful of this dairy-free alternative as it contains a high level of arsenic. Don't worry about other rice products such as rice cakes and rice as these are perfectly safe for your baby to have before 12 months, it's just the rice milk you need to avoid as this is a more concentrated form and we don't yet know the long-term effects of this.",
  },
  {
    title: 'High mercury fish',
    body: 'Research shows that regularly feeding baby fish can boost IQ. Just avoid those with high levels of mercury (so, shark, swordfish and marlin, among others). Instead, stick to the many other varieties of fish, including salmon, haddock, pollock, cod and mackerel, to name some. Canned and fresh tuna also gets the thumbs up!',
  },
  {
  ...
  },
  {
    ...
    body: "Nutritious food like large blueberries, cherry tomatoes and grapes are all fine to offer, but they will need to be quartered before giving them to your baby. Whole nuts are off the cards until your baby is at least 5 years of age. Instead, serve these ground or in the form of smooth nut butters, so long as they don't contain any added salt or sugar.",
  },
  {
    title: 'Salt',
    body: "Don't add salt to your baby's food and don't use your normal stock cubes or gravy, as they're often high in salt. Remember this when you're cooking for the family if you plan to give the same food to your baby. You can get special baby stock cubes, or make your own.",
  },
];
      ...
      <main className="bg-white">
        <article className="mx-auto mt-[40px] w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.lead}>
            Although weaning opens the floodgates to a whole host of new and
            exciting foods, tastes and textures, there are some foods
            you&apos;ll need to avoid during your baby&apos;s first year.
          </p>
