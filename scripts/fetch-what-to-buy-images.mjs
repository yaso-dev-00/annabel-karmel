...
const slug = "what-to-buy";
const outDir = path.join("public", "articles", slug);
const listingHero = path.join("public", "advice-category", "pregnancy-tips", "what-to-buy.jpg");
...
await tryDownload(
  [`${AK}/2016/07/what-to-buy-optimized.jpg`, `${AK}/2016/07/what-to-buy.jpg`],
