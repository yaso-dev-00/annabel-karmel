    ...
    groups: [
      {
        title: "By Age",
        links: [
          { label: "First Foods", href: "/recipes/first-foods" },
          { label: "6 Months +", href: "/recipes/6-9-months" },
          { label: "9-12 months", href: "/recipes/9-12-months" },
          { label: "12-18 months", href: "/recipes/12-18-months" },
          { label: "18 Months +", href: "/recipes/18-months-plus" },
          { label: "Family", href: "/recipes/family" },
        ],
      },
      {
        title: "Meal Times",
        links: [
          { label: "Breakfast", href: "/recipes/meal-time/breakfast" },
          { label: "Snacks", href: "/recipes/meal-time/snacks" },
          { label: "Main Meals", href: "/recipes/meal-time/main-meals" },
          { label: "Desserts", href: "/recipes/meal-time/desserts" },
          { label: "Weaning", href: "/recipes/meal-time/weaning" },
        ],
      },
      {
        title: "Free From",
        links: [
          { label: "Plant Based", href: "/recipes/free-from/plant-based" },
          { label: "Vegetarian", href: "/recipes/free-from/vegetarian" },
          { label: "Dairy Free", href: "/recipes/free-from/dairy-free" },
          { label: "Egg Free", href: "/recipes/free-from/egg-free" },
          { label: "Gluten Free", href: "/recipes/free-from/gluten-free" },
          { label: "Nut Free", href: "/recipes/free-from/nut-free" },
        ],
      },
    ],
  },
