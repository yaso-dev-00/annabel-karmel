...
const recipes = [
  {
    ...
    excerpt:
      "This fruit puree can be made with just apples and pears when peaches aren't in season. Post Views: 411",
  },
  {
    ...
    image:
      '/articles/annabels-top-10-summer-baby-purees/porridge-apple-pear-apricot-puree.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/annabels-top-10-summer-baby-purees/peach-apple-strawberry-puree.jpg',
    excerpt:
      'This fruit puree is best made in the summer when peaches are in season. Post Views: 285',
  },
  {
    title: 'Apple, Blueberry & Pear Puree',
    href: 'https://www.annabelkarmel.com/recipes/apple-blueberry-pear-puree/',
    image:
      '/articles/annabels-top-10-summer-baby-purees/apple-blueberry-pear-puree.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/annabels-top-10-summer-baby-purees/nectarine-apple-puree.jpg',
    excerpt:
      'A delicious fruit puree to make when sweet nectarines are in season. Post Views: 571',
  },
  {
    ...
    excerpt:
      'This Plum, Peach and Prunes puree is also good stirred into porridge for breakfast. Post Views: 558',
  },
  {
  ...
  },
  {
    ...
    image:
      '/articles/annabels-top-10-summer-baby-purees/aromatic-beef-sweet-pepper-apricots.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/annabels-top-10-summer-baby-purees/salmon-sweet-potato-spinach.jpg',
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} md:text-left text-center`}>
            Summertime and the living is easy... especially with these easy,
            peasy baby purees!
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            Whether you and your little one are taking the spoon or baby-led
            weaning route, purees are a great way to up your little one's
            nutrients and introduce them to more lumpy textures.
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            Nutritious, delicious and oh-so easy, all you need to do is blend a
            bunch of ingredients together and you're good to go!
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            <strong>
              Here are my top 10 baby purees for your little ones to try this
              summer:
            </strong>
          </p>
