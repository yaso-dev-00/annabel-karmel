...
const recipes = [
  ...
  },
  {
    ...
    image: "/articles/summer-recipes/strata-with-cheese-bacon-eggs-tomatoes.png",
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} text-center`}>
            Summer is finally here, and we couldn&apos;t be more excited! To kick off the season, we&apos;ve teamed up
            with our friends at Baker Street to bring you a collection of mind-blowing recipes that scream summer vibes.
          </p>
          <p className={`${styles.intro}  text-center`}>
            Whether you&apos;re planning family BBQ&apos;s or dreaming of mouth-watering desserts, these simple &amp;
            delicious creations will take your taste buds on the ultimate summer adventure.
          </p>
