      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[16px] sm:px-[12px] md:mt-[40px] md:px-[14px] md:pt-[20px]">
          <div className="mx-auto">
            ...
            <p className={styles.bodyText}>
              A food allergy is when your baby&apos;s immune system has a bad
              (adverse) reaction to a usually harmless protein in a food,
              leading to the release of histamine and other chemicals that cause
              symptoms such as itch and swelling.
            </p>
            <p className={styles.bodyText}>
              If your baby has a food allergy, he is likely to show symptoms
              just a few minutes after having the food.
            </p>
            <p className={styles.bodyText}>
              Food allergies are common in babies and young children, and your
              child is more likely to have a food allergy if you have a family
              history of them, or of other allergic conditions, such as asthma,
              hayfever or eczema. The link between food allergies and{' '}
              <Link
                href="/is-eczema-linked-to-food-allergies"
                className={styles.inlineLink}
              >
                eczema
              </Link>{' '}
