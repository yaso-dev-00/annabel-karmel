...
const recipes = [
  ...
  },
  {
    ...
    image:
      '/articles/10-healthy-nutritious-lunchbox-ideas/turkey-vegetable-rice-salad.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-healthy-nutritious-lunchbox-ideas/veggie-packed-frittata-muffins.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-healthy-nutritious-lunchbox-ideas/chicken-tomato-corn-fritters.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-healthy-nutritious-lunchbox-ideas/macaroni-cheese-muffins.jpg',
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro}  md:text-left text-center`}>
            A new school term calls for fresh ideas to boost brainpower and feed
            imaginations!
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            We all know how important it is for little learners to stay fuelled
            on the right foods to support their development, so it's time to
            refresh those lunchboxes with a host of energy-boosting recipes from
            Annabel's kitchen.
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            But healthy eating doesn't have to stop at the school gate; we've
            got lots of brand new simple and healthy recipes for after school
            snacks and midweek meals.
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            This new school term, let's liven up those lunchboxes, shake-up
            snack time, and put the 'mmm' into midweek meals.
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            Here are my Top 10 delicious & nutritious lunchbox fillers for you
            to try this Back to School season!
          </p>
