...
export function RecipeDetailPage({ title, shareUrl }: RecipeDetailPageProps) {
  const share = buildShareLinks(shareUrl, title);
      ...
      <main className="bg-white">
        <div className="mx-auto max-w-[1200px] px-3.5 pt-7 md:px-3.5">
          ...
          >
            ...
            {" > "}
            <Link href={demo.breadcrumbCategory.href} className={styles.breadcrumbLink}>
              {demo.breadcrumbCategory.label}
            </Link>
          </nav>
            ...
            <div className="min-w-0">
              ...
              <ul className="m-0 flex list-none flex-col gap-4 p-0">
                <li className="flex items-start gap-3 font-[family-name:var(--font-montserrat)] text-base leading-[1.45] text-[#3a3a3a]">
                  ...
                  <TaxonomyLinks items={[...demo.allergens]} />
                </li>
                <li className="flex items-start gap-3 font-[family-name:var(--font-montserrat)] text-base leading-[1.45] text-[#3a3a3a]">
