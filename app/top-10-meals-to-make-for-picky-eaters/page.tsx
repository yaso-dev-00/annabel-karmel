...
import { pickyEaterRecipes, pickyEatersIntro } from "@/data/top-10-meals-to-make-for-picky-eaters-page";
...
const relatedArticles = getRelatedArticles("/top-10-meals-to-make-for-picky-eaters");
