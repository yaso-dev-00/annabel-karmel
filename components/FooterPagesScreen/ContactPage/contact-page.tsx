...
import { ContactSelect } from '@/components/FooterPagesScreen/ContactSelect';
    ...
    <main className={styles.page}>
      <section className={styles.shell}>
        ...
        <p className={styles.intro}>
          We love to hear from our customers and website visitors so please feel
          free to drop us a line – no matter what your enquiry is about. If you
          love our products or have a suggestion, we&apos;d especially love to
          hear your thoughts.
        </p>
        <p className={styles.intro}>
          We look to respond to all enquiries within two working days.
        </p>

        <div className={styles.formCard}>
          {submitted ? (
            <p className={styles.successMessage}>
              Thank you for your message. We aim to respond within two working
              days.
            </p>
          ) : (
            <form className={styles.form} onSubmit={handleSubmit} noValidate>
              <div className={styles.field}>
                ...
                />
                {errors.enquiryType ? (
                  <p className={styles.error}>{errors.enquiryType}</p>
                ) : null}
              </div>
        ...
        <p className={styles.emailNote}>
          ...
          <a
            href="mailto:contact@annabelkarmel.com"
