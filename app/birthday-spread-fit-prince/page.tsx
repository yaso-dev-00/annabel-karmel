      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[12px] pt-[20px] md:px-[14px] md:pt-[30px]">
          <h1 className={styles.pageTitle}>
            Annabel&apos;s Birthday Party Recipes
          </h1>
            ...
            <section key={recipe.title} className="mt-[34px]">
              ...
              >
                <img
                  src={recipe.image}
                  alt={recipe.alt}
                  className="mt-[30px]   md:max-w-[700px]! mx-auto"
                />
              </a>
          ...
          <p className={styles.milestoneText}>
            We hope these birthday party recipes have given you inspiration for
            the next milestone!
          </p>

          <section
            style={{ maxWidth: '1000px' }}
            className="mt-[42px] md:max-w-[1000px]! mx-auto grid max-w-full grid-cols-1 min-[900px]:grid-cols-2  gap-12"
          >
            <img
            ...
            <div className={`min-w-0 flex-1 ${styles.appPromoCopy}`}>
              <p className={styles.body}>
                ...
                <strong>Annabel&apos;s Baby &amp; Toddler Recipe App</strong>.
                New and updated with over 350 delicious recipes, as well as a
                host of features, this is the must-have app for delicious
                mealtimes.
              </p>
