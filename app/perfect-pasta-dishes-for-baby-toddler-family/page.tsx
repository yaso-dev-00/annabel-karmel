...
const recipes = [
  ...
  },
  {
    ...
    image:
      '/articles/perfect-pasta-dishes-for-baby-toddler-family/vroom-vroom-veggie-packed-bolognese.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/perfect-pasta-dishes-for-baby-toddler-family/tuna-fusilli-tomato-sauce.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/perfect-pasta-dishes-for-baby-toddler-family/pasta-shells-tomato-mascarpone.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/perfect-pasta-dishes-for-baby-toddler-family/annabels-super-fuel-veggie-fusilli.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/perfect-pasta-dishes-for-baby-toddler-family/popeye-pasta.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/perfect-pasta-dishes-for-baby-toddler-family/babys-first-bolognese-sauce.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/perfect-pasta-dishes-for-baby-toddler-family/meatball-pasta-bake.jpg',
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} md:text-left text-center`}>
            Pasta is a family staple for good reason - not only is it delicious
            and pastably one of the easiest and quickest things to make, but
            it’s also packed with fibre, protein and a host of other nutritional
            benefits.
            <br />
            <br />
            Tuck into these delicious and oh-so-saucy pasta dishes that count
            towards your 5-a-day – see, the pastabilities are endless!
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            Try these scrummy recipes to tide you and your little one over at
            lunchtime, dinnertime or even as an energy-boosting midday snack.
            Trust us, they definitely pasta the taste test!
          </p>
