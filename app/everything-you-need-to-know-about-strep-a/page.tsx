import { FoodCategoryAccordion, type FoodCategoryItem } from "@/components/ArticleScreen/FoodCategoryAccordion";
...
const relatedArticles = getRelatedArticles("/everything-you-need-to-know-about-strep-a");
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.body}>
            Parents are understandably worried about Group A strep considering the recent devastating cases in the UK.
            Whilst the bacterial infection has always existed, we seem to have an alarmingly high number of cases for this
            time of year. However, NHS GP, The Mail on Sunday health columnist{" "}
            <strong>
              <em>
                <u className={styles.doctorName}>Dr Ellie Cannon</u>
              </em>
            </strong>{" "}
            has reassured parents that severe cases are incredibly rare and that we haven&apos;t yet surpassed the amount
            we&apos;d expect in a normal year. The concern is not necessarily how many cases, but rather the timing of
            them happening before the peak of winter.
          </p>

          <p className={styles.bodySpacing}>
            There are a host of explanations for why this could be happening including reduced immunity in children due
            to social distancing and changes in weather, however Dr Ellie reassures that most children who have Group A
            strep will develop a mild version of the illness, less likely the invasive kind. You can find out more about
            her parental advice in her new book Keep Calm The New Mum&apos;s Manual.
          </p>
