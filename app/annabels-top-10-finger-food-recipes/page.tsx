...
const recipes = [
  ...
  },
  {
    ...
    image:
      '/articles/annabels-top-10-finger-food-recipes/plant-based-veggie-croquettes.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/annabels-top-10-finger-food-recipes/tofu-veggie-bites.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/annabels-top-10-finger-food-recipes/salmon-veggie-bites.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/annabels-top-10-finger-food-recipes/egg-free-chicken-veggie-bites.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/annabels-top-10-finger-food-recipes/no-sugar-chocolate-orange-energy-balls.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/annabels-top-10-finger-food-recipes/chicken-quinoa-apple-sage-balls.png',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/annabels-top-10-finger-food-recipes/mini-energy-balls.png',
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} md:text-left text-center`}>
            These finger food recipes are easy to make and tasty and convenient
            for when you’re on the go. There are so many combinations you can
            try. From sweet to savoury, veggie to energy balls, cast your eyes
            on my top ten ball finger food recipes for some fun weaning snack
            inspiration!
          </p>
          <h1 className="text-center font-(--font-display)! px-2 md:px-0 md:text-left text-[40px] font-[500]! text-[#3a3a3a] mt-[40px]">
            Annabel's top 10 finger food recipes
          </h1>
