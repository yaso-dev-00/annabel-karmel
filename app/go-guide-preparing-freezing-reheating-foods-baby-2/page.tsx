...
const relatedArticles = getRelatedArticles("/go-guide-preparing-freezing-reheating-foods-baby-2");
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={`${styles.intro} mt-[20px]!`}>
            There&apos;s no doubt that there are so many exciting things to think about when you begin your weaning
            journey with your little one; choosing a highchair, shopping for snazzy bibs, debating which cup and cutlery
            is best and deciding what amazing tastes to expose your baby to first… but it&apos;s important not to forget
            that amongst all of this, any food you serve needs to be safe! Babies and young children don&apos;t have the
            same immune system as us adults (or even older children) so food safety is essential. We need to make sure
            we&apos;re extra careful with their little tummies!
          </p>
          <p className={styles.intro}>
            ...
            but it&apos;s not just restaurants that cause food poisoning – cooking at home can also make you (or your
            family) sick. The good news is that there are so many things you can do whilst preparing food to prevent
          ...
          <p className={styles.bodyText}>
            When it comes to food safety, keeping clean is so important. In reality, this doesn&apos;t mean having a
            &apos;spotless&apos; kitchen but instead, a clean environment where you prepare food, with clean hands,
          ...
          <ul className={styles.bulletList}>
            {cleanTips.map((tip) => (
              <li key={tip.label} className={styles.bulletItem}>
                <strong className={styles.bulletItemStrong}>{tip.label}</strong> – {tip.text}
              </li>
            ))}
          </ul>

          <h2 className={styles.sectionHeading}>Food Safety – Cooking food for your baby checklist!</h2>
          <div className="my-[22px]">
            <img
          ...
          <p className={styles.bodyText}>
            Cooking veggies by steaming, boiling or roasting is pretty straightforward, but those first tastes
            don&apos;t last for long and you&apos;ll soon be branching out to more exciting foods for your baby to try,
            many of which may include meat or fish. Regardless of how you serve meat to your little one, it&apos;s
            important to make sure that it is thoroughly cooked.
          </p>
          <p className={styles.bodyText}>
            Remember – just because it&apos;s cooked on the outside, doesn&apos;t mean it&apos;s cooked on the inside!
            Here&apos;s how you can check that meat is safe for your baby to eat…
          </p>
          <ul className={styles.bulletList}>
          ...
          <p className={styles.bodyText}>
            If you find your baby puree needs thinning after cooking, check out Jenna&apos;s article{" "}
          ...
          <p className={styles.bodyText}>
            I am a huge fan of keeping leftovers to use as an easy meal another day! After cooking, make sure you cool
            any leftovers and pop into the fridge or freezer as soon as possible. Never allow food to sit out on the side
            for more than 2 hours after cooking.
          </p>
          <p className={`${styles.bodyText} mb-[20px]!`}>
            Be aware that simply putting your hot food in the fridge may not be enough to make sure it is cooled down
            quickly and safely. There are lots of things you can do to help speed up the cooling of food, such as
            dividing into smaller portions, using an ice bath or stirring regularly.
          </p>

          <h2 className={styles.sectionHeading}>Keep leftovers for another day</h2>
          <div className="my-[22px]">
            <img
          ...
          <p className={styles.bodyText}>
            Whatever your situation, whether you have children or not… reheating leftovers is always a good idea! As a
            rule of thumb, leftover food can be kept in the fridge and used within 2 days (1 day for rice) but if you
            want longer than this, then pop your leftovers in the freezer.
          </p>
          <p className={`${styles.bodyText} mb-[20px]!`}>
            Even if you used raw meat or veg which was previously frozen, once cooked you can freeze the leftovers.
            Freezing &quot;pauses&quot; the growth of bacteria, locks in nutrients, prevents spoilage and ultimately helps
            reduce wastage!
          </p>
          ...
          <p className={`${styles.bodyText} mb-[20px]!`}>
            If defrosting baby purees, the best way to do this would be overnight in the fridge and use within 24
            hours. But, did you know that you can cook baby purees from frozen?!
          </p>
          ...
          <p className={styles.bodyText}>
            Baby purees are often best served at room temperature, but don&apos;t be tempted to partially reheat food for
            your baby to avoid having to wait for it to cool. Unless served cold straight from the fridge, baby purees
            should always be reheated until piping hot, which means steaming throughout, to kill off bacteria.
          </p>
          <p className={styles.bodyText}>The best ways to reheat baby purees are:</p>
          <ul className={styles.bulletList}>
          ...
          <p className={styles.bodyText}>
            If cooking a portion of baby puree from frozen, make sure you increase the cooking time and stir regularly
            (every 20 – 30 seconds) to ensure there are no hidden hot spots and that the puree is evenly heated so it is
            piping hot throughout.
          </p>
          <p className={styles.bodyText}>
            Remember that foods can only be reheated once so make sure you divide your puree into baby friendly portions
            before storing in the fridge or freezer!
          </p>
          <p className={styles.bodyText}>
            We hope these tips and tricks have helped you become more confident when it comes to food safety for your
            little ones!
          </p>
          ...
          <div className={styles.authorBlock}>
            ...
            <div className={styles.authorFooter}>
              ...
              <p className={styles.authorCta}><a
