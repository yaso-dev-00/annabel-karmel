      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[14px] pb-[56px] pt-[18px]">
          <div className="my-[8px] mb-[60px]">
            <img
              src="/articles/get-your-free-top-50-first-foods-list/top-collage.png"
              alt="Top 50 First Foods collage"
            />
          </div>
          <p className={`${styles.title} hover:text-[#e98c9a]! cursor-pointer`}>
            <a href="https://pdflink.to/annabel-karmel-pampers-top-50-first-foods-checklist/">
              Here is your FREE Top 50 First Foods Checklist
            </a>
          </p>
          <p className={styles.partner}>
            <span className={styles.partnerWrap}>
              ...
              <img
                src="/articles/get-your-free-top-50-first-foods-list/pampers-logo.png"
                alt="Pampers"
              />
            </span>
          </p>
          ...
          <p className={styles.lead}>
            ...
            to help little food explorers #GetToGrips with 50 of the most
            nutritious foods around.
          </p>
          <p className={styles.lead}>
            This is your FREE checklist to help you try and tick off a raft of
            new tastes and textures with your baby - whether you are pureeing or
          ...
          <div className="my-[4px] mb-[32px] mt-[70px] w-full flex justify-center">
            <img
              src="/articles/get-your-free-top-50-first-foods-list/checklist-spread.png"
              alt="Top 50 checklist"
            />
          </div>
            ...
            <div className="grid grid-cols-2 items-center gap-[16px] max-[900px]:grid-cols-1">
              <div>
                ...
                <p className={styles.didBody}>
                  The start of weaning provides the ultimate &apos;flavour
                  window&apos; where babies are more likely to accept new foods.
                  The more variety you provide, the more they can adjust and
                  accept those flavours.
                </p>
              </div>
              <img
          ...
          <h2 className={styles.mushyTitle}>
            For all those mushy, squishy moments...
          </h2>
          <p className={styles.mushyText}>
            As little ones have fun getting to grips with a world of food, pair
            with{' '}
            <a
              className={styles.partnerLinkText}
              href="https://www.pampers.co.uk/"
            ...
            Harmonie Aqua Baby Wipes which are safe and gentle to use even on
          ...
          <div className="mx-auto mt-[50px]! w-full max-w-[1024px]">
            <picture>
              ...
              />
              <img
                src="/articles/get-your-free-top-50-first-foods-list/pampers-aqua.png"
          ...
          <div className="my-[18px] mb-[8px] flex flex-wrap max-[900px]:flex-col items-center justify-center gap-[22px]">
            ...
            <a
              ...
              href="https://www.instagram.com/pampersuk_ire/"
            >
              <img
                src="/articles/get-your-free-top-50-first-foods-list/instagram.png"
                alt="Instagram"
              />
              @pampersuk_ire
            </a>
            <a
              className={styles.socialLink}
              href="https://www.facebook.com/PampersUKIre"
            >
              <img
                src="/articles/get-your-free-top-50-first-foods-list/facebook.png"
                alt="Facebook"
              />
              @pampersUKIre
            </a>
          ...
          <div className="mt-[100px]! text-center mb-10">
            ...
            <p className={`${styles.relatedText} max-[900px]:text-[17px]!`}>
