...
export function PaddingField({
  ...
  const [mode, setMode] = useState<'unified' | 'sides'>(() =>
    hasIndividualPadding(settings) || isCssLengthShorthand(settings.padding)
      ? 'sides'
      : 'unified',
  );
      ...
      {mode === 'unified' ? (
        <>
          ...
          <p className={styles.hint}>
            Same value on all sides. Choose unit from the dropdown (default px).
          </p>
        </>
      ) : (
        <>
            ...
            <div className={`${styles.sideCell} ${styles.sideTop}`}>
              ...
              <CssLengthInput
                ...
                onChange={(padding_top) =>
                  onChange({ padding_top, padding: undefined })
                }
                placeholder="0"
                compact
            ...
            <div className={`${styles.sideCell} ${styles.sideLeft}`}>
              ...
              <CssLengthInput
                ...
                onChange={(padding_left) =>
                  onChange({ padding_left, padding: undefined })
                }
                placeholder="0"
                compact
            ...
            <div className={`${styles.sideCell} ${styles.sideRight}`}>
              ...
              <CssLengthInput
                ...
                onChange={(padding_right) =>
                  onChange({ padding_right, padding: undefined })
                }
                placeholder="0"
                compact
            ...
            <div className={`${styles.sideCell} ${styles.sideBottom}`}>
              ...
              <CssLengthInput
                ...
                onChange={(padding_bottom) =>
                  onChange({ padding_bottom, padding: undefined })
                }
                placeholder="0"
                compact
