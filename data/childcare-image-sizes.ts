/** Responsive `sizes` hints for next/image across childcare page breakpoints. */
export const childcareImageSizes = {
  heroDesktop:
  ...
  fullWidthCard:
    "(max-width: 767px) 100vw, (max-width: 1439px) 1300px, 1300px",
  ...
  weaningCard: "(max-width: 767px) 60vw, (max-width: 1023px) 30vw, 200px",
  quoteImage: "(max-width: 767px) 80vw, (max-width: 1023px) 40vw, 600px",
} as const;
