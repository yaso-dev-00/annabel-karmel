...
const relatedArticles = getRelatedArticles(
  '/10-quick-easy-puff-pastry-recipes',
);
...
const recipes = [
  ...
  },
  {
    ...
    image:
      '/articles/10-quick-easy-puff-pastry-recipes/tomato-mozzarella-pinwheels.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-quick-easy-puff-pastry-recipes/puff-pastry-cheese-stars.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-quick-easy-puff-pastry-recipes/chicken-sausage-rolls.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-quick-easy-puff-pastry-recipes/chicken-leek-mushroom-pie.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-quick-easy-puff-pastry-recipes/puff-pastry-apple-almond-tarts.jpg',
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} text-center`}>
            Beloved by the nation for almost 70 years, Jus-Rol helps hungry
            families create delicious dishes with their ready-made pastry range.
          </p>
          <p className={`${styles.intro}  text-center`}>
            We&apos;re thrilled to join forces with Jus-Rol to inspire families
            to reduce food waste with leftovers recipes. Whether you&apos;ve got
            some leftover chicken from the Sunday roast or some extra puff
            pastry from yesterday&apos;s pie, give these recipes a go to make
            your food go further!
          </p>
