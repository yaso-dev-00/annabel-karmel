...
export const breastfeedingArticles: Record<string, BreastfeedingArticle> = {
    ...
    blocks: [
      {
        type: "paragraph",
        bold: true,
        content: ["Here is the most important information on storing pumped breastmilk correctly."],
      },
      {
        type: "list",
        items: [
  ...
  pumping: {
    metaTitle: "Pumping Breast Milk | Breastfeeding Tips & Advice | Annabel Karmel",
    metaDescription:
  ...
  "breastfeeding-friendly-bottle-feeding": {
    ...
    blocks: [
      ...
      {
        type: "relatedLinks",
        intro: "If you found this article helpful, you may be interested in reading:",
        links: [
          { label: "Introduction to breastfeeding", href: "/advice/introduction-to-breastfeeding" },
          { label: "Breastfeeding Tips & Advice", href: "/advice-category/breastfeeding-advice" },
        ],
      },
    ],
  },
    ...
    blocks: [
      ...
      { type: "milkMakingMamaClosing" },
      {
        ...
        links: [
          ...
          { label: "Newborn feeding patterns", href: "/advice/newborn-feeding-patterns" },
        ],
      },
    ],
  },
  ...
  "finding-pumping-routine": {
    metaTitle: "Finding a pumping routine | Breastfeeding tips & advice | Annabel Karmel",
    metaDescription:
  ...
  "breastfeeding-sessions": {
    ...
    blocks: [
      ...
      {
        type: "paragraph",
        content: ["These endless nursing sessions left me questioning if this is \u201cnormal\u201d."],
      },
      {
        type: "paragraph",
        content: [
  ...
  "breast-feeding-myths": {
    metaTitle: "Myths about breastfeeding and breast milk busted | Annabel Karmel",
    metaDescription:
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          {
            title: "\u201cBaby is feeding all the time and I don't feel like I don't have enough milk\u201d",
            paragraphs: [
          ...
          {
            title: "\u201cBreastmilk does not keep your baby full enough to sleep through the night\u201d",
            paragraphs: [
          ...
          {
            title: "\u201cBeing a human pacifier or nursing baby to sleep is bad\u201d",
            paragraphs: [
          ...
          {
            title: "\u201cStress, tiredness and lack of food or drink cause a bad milk supply\u201d",
            paragraphs: [
          ...
          {
            title: "\u201cYou should space out feedings to let your breast fill up\u201d",
            paragraphs: [
          ...
          {
            title: "\u201cYou only have milk when your milk comes in 2-3 days after labour\u201d",
            paragraphs: [
          ...
          {
            title: "\u201cYou can't tell if your baby is getting enough milk whilst breastfeeding\u201d",
            paragraphs: [
          ...
          {
            title: "\u201cIf you have small breasts you can't make enough milk\u201d",
            paragraphs: [
  ...
  "introduction-to-breastfeeding": {
    metaTitle: "Introduction to breastfeeding | Getting started | Annabel Karmel",
    metaDescription:
    ...
    blocks: [
      ...
      {
        type: "milkMakingMamaClosing",
        prefix: "I hope my advice articles will empower and support you nourish your baby.",
      },
    ],
  },

  "breastfeeding-getting-started": {
    metaTitle: "Getting the perfect latch | Breastfeeding tips & advice | Annabel Karmel",
    metaDescription:
  ...
  "have-i-got-enough-breast-milk": {
    metaTitle: "You've got enough milk | Breastfeeding Tips & Advice | Annabel Karmel",
    metaDescription:
  ...
  "breast-milk": {
    metaTitle: "Day one of breast milk | Breastfeeding tips & advice | Annabel Karmel",
    metaDescription:
  ...
  "reflux-expert-advice": {
    metaTitle: "Reflux: Expert Advice | Breastfeeding Tips & Advice | Annabel Karmel",
    metaDescription:
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            title: "Tips on coping with baby reflux to prevent development of GORD",
            listItems: [
