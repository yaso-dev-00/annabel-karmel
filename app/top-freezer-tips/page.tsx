      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.body}>
            Wouldn&apos;t it be great if we could freeze time? Imagine all those
            extra jobs and chores we could get done? The great thing about the
            trusty freezer is that it acts like a pause button, saving you time,
            money and effort in the kitchen.
          </p>
          ...
          <ol className={styles.numberedList}>
            {freezerTips.map((tip) => (
              <li key={tip.title} className={styles.numberedItem}>
                <strong className={styles.numberedItemTitle}>
                  {tip.title}
                </strong>
                . {tip.body}
              </li>
