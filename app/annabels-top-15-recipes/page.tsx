      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[14px] pb-[54px] pt-[60px]">
          ...
          <p className={styles.intro}>
            Stuck for fresh mealtime ideas? We&apos;ve done the hard work for you and put together our top 15
            recipes of all time! We have catered to all in this line up from baby recipes to toddlers to family
            meals.
          </p>
              ...
              <li key={recipe.href} className={styles.recipeCard}>
                ...
                >
                  <span className={styles.recipeImageWrap}>
                    <img src={recipe.image} alt={recipe.title} className={styles.recipeImage} loading="lazy" />
                  </span>
          ...
          <section className="relative left-1/2 right-1/2 mt-[80px] flex w-screen -translate-x-1/2 flex-col items-center px-2 md:mt-[100px] md:px-4">
            <h2 className={`${styles.relatedTitle} text-center`}>Related Articles</h2>
            <p className={`${styles.relatedIntro} text-center`}>Some more articles you might enjoy...</p>
