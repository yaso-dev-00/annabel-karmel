...
export const metadata: Metadata = {
  title:
    '10 Perfect Pancake Recipes | Toddler & Child Nutrition | Annabel Karmel',
  description:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} `}>
            Whether you&apos;re looking for an easy pancake recipe to nail with
            the kids, a creative twist on a classic or something piled high with
            toppings, our perfect sweet and savoury pancake recipes are all you
            need.
          </p>
          <p className={`${styles.intro}  `}>
