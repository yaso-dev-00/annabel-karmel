      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.intro}>
            Finger foods are a fun way to encourage co-ordination and help your
            little one develop the skills necessary to bite, chew and self-feed.
            Finger foods need to be easy to pick up and hold, and free from
            pips, stones or bones. Once baby can pick things up with reasonable
            hand-eye coordination the fun can begin! Let them experiment with
            soft finger foods like banana or peach that can be
            &apos;gummed&apos; to a suitable consistency. The more your baby
            experiments with finger foods the quicker they will become
            proficient at feeding themself!
          </p>

          <h2 className={styles.sectionHeading}>Choking hazards</h2>
          <p className={styles.bodyText}>
            Just because your baby has teeth doesn&apos;t mean that they know
            how to chew. Sometimes babies can bite off a piece of food, try to
            swallow it whole and choke on it, so never leave your child alone
            while eating. Also they can often store food in their mouth like a
            hamster so always check that they have swallowed everything before
            leaving the room.
          </p>
