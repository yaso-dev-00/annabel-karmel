...
const tips: Tip[] = [
  {
    ...
    image:
      '/articles/top-10-tip-to-reduce-food-waste/shutterstock_1518048209-optimized.jpg',
    paragraphs: [
  ...
  },
  {
    ...
    image:
      '/articles/top-10-tip-to-reduce-food-waste/Shutterstock_130458590-optimized.jpg',
    paragraphs: [
  ...
  },
  {
    title: '5. Go Frozen',
    image:
      '/articles/top-10-tip-to-reduce-food-waste/Shutterstock_1443256970-scaled-optimized.jpg',
    paragraphs: [
  ...
  },
  {
    ...
    bullets: [
      <>
        A blender is your best friend when it comes to making the most of your
        fruit and veg leftovers, and smoothies and soups will be your go-to.{' '}
        <strong className="italic hover:text-[#e98c9a]">
          <a
            href="https://www.annabelkarmel.com/recipes/carrot-cheese-muffins/"
            target="_blank"
            rel="noreferrer"
          >
            {' '}
        ...
        <strong className="italic hover:text-[#e98c9a]">
          <a
            href="https://www.annabelkarmel.com/recipes/potato-spinach-sweet-pepper-pea-frittata/"
            target="_blank"
            rel="noreferrer"
          >
            {' '}
        ...
        are also a fantastic base for using up any veg you've got left at the
        end of the week.
      </>,
      <>
        ...
        <strong className="italic hover:text-[#e98c9a]">
          <a
            href="https://www.annabelkarmel.com/recipes/banana-carrot-seed-bread/"
            target="_blank"
            rel="noreferrer"
          >
            {' '}
  ...
  },
  {
    ...
    image:
      '/articles/top-10-tip-to-reduce-food-waste/Shutterstock_1495668200-scaled-optimized.jpg',
    paragraphs: [
  ...
  },
  {
    ...
    image:
      '/articles/top-10-tip-to-reduce-food-waste/Shutterstock_633563996-scaled-optimized.jpg',
    paragraphs: [
  ...
  },
  {
    ...
    image:
      '/articles/top-10-tip-to-reduce-food-waste/hidden-veg-smoothie-optimized.png',
    paragraphs: [
    ...
    <>
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[15px]! pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          ...
          <p className={`${styles.intro} mt-[30px]! text-center italic `}>
            {' '}
            Take a look at{' '}
            <strong className="text-[#000080]">
              {' '}
              <a
                href="https://lovebakerstreet.com/blog/creative-leftover-recipes-to-tackle-food-waste/?utm_source=blog+&utm_medium=hub+page&utm_campaign=food+waste+&utm_id=Annabel+Karmel+"
                target="_blank"
                rel="noreferrer"
              >
                Baker Street's creative leftover recipes
              </a>
            </strong>{' '}
            to help you and your family tackle food waste at home.
          </p>
          <p className={`${styles.intro} mt-[30px]!  text-center `}>
            {' '}
            Here are our top ten tips to help you minimise food wastage at
            home...
          </p>
          ...
          <div className="mt-[70px]! space-y-[40px]">
            {tips.map((tip, index) => (
              <section key={tip.title}>
                <h2 className="font-(--font-display) text-[40px] text-[#3a3a3a] leading-[1.1] font-[700]! text-center md:text-left ">
                  {tip.title}
                </h2>
                <img
                  src={tip.image}
                  alt={tip.title}
                  className="mt-[40px] md:max-w-[820px] mx-auto w-full"
                />

                {tip.paragraphs.map((paragraph) => (
                  <p
                    key={paragraph}
                    className={`${styles.cardExcerpt} mt-[40px]!`}
                  >
                    {paragraph}
                  </p>
                ))}
                ...
                {tip.bullets ? (
                  <ul className="mt-[40px] md:max-w-[1100px] mx-auto list-disc pl-[28px]">
                    {tip.bullets.map((bullet, bulletIndex) => (
                      <li
                        key={`${tip.title}-bullet-${bulletIndex}`}
                        className={`${styles.cardExcerpt} text-[16px]! text-center md:text-left  md:text-[20px]! mt-[10px]!`}
                      >
                        {bullet}
                      </li>
                    ))}
          ...
          <p
            className={`${styles.cardExcerpt} mt-[100px]! text-center leading-[1.42]! `}
          >
            Follow Baker Street on{' '}
            <strong className="text-[#000080]">Instagram</strong>,{' '}
            <strong className="text-[#000080]">Facebook</strong> &{' '}
            <strong className="text-[#000080]">TikTok</strong> for more ways to
            use their cleverly packed range of products that last longer to help
            you and your family tackle food waste.
          </p>
