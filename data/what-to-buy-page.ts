...
export const whatToBuyAccordionItems: EggQuestionItem[] = [
  ...
  {
    title: "Bottles & feeding equipment",
    paragraphs: [
...
export const whatToBuyRelatedArticles: RelatedArticleItem[] = [
  {
    href: "/advice/nesting",
