      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[14px] md:px-[14px]">
          <div className="mb-[60px]">
            <img
              src="/articles/haunted-toast-toppers/hero.png"
              alt="Haunted Toast Toppers"
            />
          </div>
          ...
          <p className={styles.partnerLine}>
            ...
            <a href="https://www.egginfo.co.uk/">
              <img
                src="/articles/haunted-toast-toppers/british-lion-logo.png"
                alt="British Lion eggs"
                width={102}
                height={102}
              />
            </a>
          ...
          <div className="md:min-w-[1020px] mx-auto">
            <p className={styles.introText}>
              Your breakfast staple but make it SPOOKY! These easy ideas in
              partnership with{' '}
              <a
              ...
              make for the scariest wake-up call.
            </p>
            <p className={`${styles.introText} mt-[40px]!`}>
              Eggs are the BEST fuel as they're packed with protein, vitamins +
              minerals - ideal for growing little ghosts and ghouls. Always look
              for the British Lion mark on the shell and pack as these are
              perfectly safe for babies, kids and mums-to-be to enjoy runny.
            </p>
          </div>
          ...
          <div className="mt-[40px] space-y-[70px]">
            {recipes.map((recipe) => (
              <section
                key={recipe.title}
                className="bg-[#F7CDB9]  px-[6px] py-[50px]"
              >
                <h2
                  className={`${styles.recipeTitle} max-[900px]:text-center!`}
                >
                  {recipe.title}
                </h2>
                <div className="grid grid-cols-2 gap-[20px] mt-[40px] ml-[10px] max-[900px]:m-0 max-[900px]:p-[10px] max-[900px]:mt-[35px]! max-[900px]:grid-cols-1">
                  ...
                  >
                    <img
                      src={recipe.image}
                      alt={recipe.imageAlt}
                      className="h-full w-full object-cover max-[900px]:object-cover  max-[900px]:aspect-square"
                    />
                  </div>
                  <div
                    className={`${recipe.imageRight ? 'order-1 max-[420px]:order-2' : 'order-2'} px-[2px]`}
                  >
                    <h3 className={styles.blockHeading}>Ingredients</h3>
                    <p className={styles.blockText}>
                      {recipe.ingredients.join('\n')}
                    </p>
                    <h3 className={`${styles.blockHeading} mt-[40px]!`}>
                      Method
                    </h3>
          ...
          <div className="mt-[60px] text-center">
            ...
            <p
              className={`${styles.relatedText} max-[900px]:text-center! max-[900px]:text-[17px]! max-[900px]:mt-[30px]!`}
            >
