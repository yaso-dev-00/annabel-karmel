...
const relatedArticles = getRelatedArticles("/development-milestones-toddlers-expect");
...
const milestoneSections: MilestoneSection[] = [
  {
    ...
    image: "/articles/development-milestones-toddlers-expect/milestone-1-year.png",
  ...
  },
  {
    ...
    image: "/articles/development-milestones-toddlers-expect/milestone-2-year.png",
  ...
  },
  {
    ...
    image: "/articles/development-milestones-toddlers-expect/milestone-3-year.jpg",
  ...
  },
  {
    ...
    image: "/articles/development-milestones-toddlers-expect/milestone-4-year.jpg",
  ...
  },
  {
    ...
    image: "/articles/development-milestones-toddlers-expect/milestone-5-year.jpg",
        ...
        <article className="mx-auto w-full mt-[50px]! max-w-[1200px] px-[8px] pb-[14px] pt-[24px] md:px-[14px] md:pt-[34px]">
          <div className="space-y-[24px]">
            <p className={styles.lead}>
              Skills such as taking the first step, smiling for the first time, and waving &ldquo;bye-bye&rdquo; are
              called developmental milestones. Development milestones are things most children can do by a certain age.
              Children reach milestones in how they play, learn, speak, behave, and move (like crawling, walking, or
              jumping).
            </p>
            <p className={`${styles.body} font-semibold`}>
              Keep reading to find out which development milestones your little ones should be reaching starting from 1
              year all the way to 5 years old.
            </p>
          </div>
          ...
          <div className="mt-[40px] space-y-[48px]">
            {milestoneSections.map((section) => (
              <section key={section.title}>
                ...
                <img src={section.image} alt={section.imageAlt} className="mx-auto mt-[30px] w-full max-w-[650px]" />
          ...
          <section className="mt-[28px]">
            <p className={styles.body}>
              ...
              <a href="https://www.annabelkarmel.com/advice/walking/" target="_blank" rel="noreferrer" className={styles.link}>
                walking
              </a>
              ,{" "}
              <a href="https://www.annabelkarmel.com/advice/talking/" target="_blank" rel="noreferrer" className={styles.link}>
                talking
              </a>{" "}
              and{" "}
              <a href="https://www.annabelkarmel.com/advice/behaviour/" target="_blank" rel="noreferrer" className={styles.link}>
                understanding toddler behaviour
              </a>
              .
            </p>

            <h2 className={`${styles.milestoneTitle} mt-[40px]`}>Learning through play with Edx Education</h2>
            <img
            ...
            <p className={`${styles.body} mt-[16px]`}>
              From early childhood active play and art &amp; craft accessories, to maths and classroom resources, Edx
              Education&apos;s innovative toys and resources provide children a fun and engaging way to learn.
            </p>
           <div className="w-full flex justify-center">
           <a href="http://www.amazon.co.uk/edxeducation" target="_blank" rel="noreferrer" className="mt-[30px] inline-flex">
              <img
            ...
            <p className={`${styles.body} mt-[30px]! flex items-center gap-[10px]`}>
              <a href="https://www.instagram.com/edxeducation/" target="_blank" rel="noreferrer" className="shrink-0">
                <img
              ...
              <a href="https://www.instagram.com/edxeducation/" target="_blank" rel="noreferrer" className={styles.link}>
