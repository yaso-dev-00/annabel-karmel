import { FoodCategoryAccordion, type FoodCategoryItem } from "@/components/food-category-accordion";
...
export const metadata: Metadata = {
  title: "Weaning premature babies | Baby Nutrition | Annabel Karmel",
  description:
...
const relatedArticles = getRelatedArticles("/weaning-premature-babies");

const CHILDRENS_NUTRITION_URL = "https://www.childrensutrition.co.uk/";

const faqItems: FoodCategoryItem[] = [
  {
    title: "What is premature?",
    paragraphs: [
  ...
  {
    title: "Corrected age and actual age",
    paragraphs: [
  ...
  {
    title: "Why does being born prematurely affect nutrition?",
    paragraphs: [
  ...
  {
    title: "What is the current guidance on premature weaning?",
    paragraphs: [
  ...
  {
    title: "What are the readiness cues for weaning a premature baby",
    paragraphs: [
  ...
  {
    title: "Is nutrition a reason to start solids?",
    paragraphs: [
  ...
  {
    title: "Are there risks in delaying weaning in a preterm baby",
    paragraphs: [
  ...
  {
    title: "Can premature baby do baby-led weaning?",
    paragraphs: [
  ...
  {
    title: "Can I prevent fussy eating?",
    paragraphs: [
  ...
  {
    title: "Do premature babies need supplements?",
    paragraphs: [
...
export default function WeaningPrematureBabiesPage() {
  return (
    <>
      <SiteHeader />
      <main className="overflow-x-hidden bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.intro}>
            There is a lot of weaning guidance available for babies born on or around their due date (from week 37 of
            pregnancy onwards), however, not a lot for those whose baby decides to make an early appearance which is
            actually around 10% of all babies!
          </p>

          <div className="mt-[28px]">
            <FoodCategoryAccordion items={faqItems} />
          </div>

          <p className={styles.closing}>
            If you would like to learn more about nutrition and feeding for babies and toddlers head over to my blog{" "}
            <a href={CHILDRENS_NUTRITION_URL} className={styles.link} target="_blank" rel="noopener noreferrer">
