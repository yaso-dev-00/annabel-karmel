...
const relatedArticles = getRelatedArticles("/enjoy-summer-2021-sani-resort-greece");
...
const sectionCards = [
  {
    ...
    image: "/articles/discover-special-offers-at-sani-resort-greece/special-offer-1.jpg",
  ...
  },
  {
    ...
    image: "/articles/discover-special-offers-at-sani-resort-greece/little-guests-card.jpg",
    buttonImage: "/articles/enjoy-summer-2021-sani-resort-greece/discover-more.png",
  ...
  },
  {
    ...
    image: "/articles/discover-special-offers-at-sani-resort-greece/little-guests-card.jpg",
    buttonImage: "/articles/enjoy-summer-2021-sani-resort-greece/discover-more.png",
    buttonHref: "https://www.sani-resort.com/en_GB/news/sani-home/upgraded-childcare-for-little-guests",
    reverse: true,
  },
];
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[28px] md:px-[14px] md:pt-[40px]">
          <section className="grid grid-cols-1 items-start min-[900px]:items-center min-[1400px]:items-start  gap-[36px] min-[900px]:grid-cols-[320px_1fr] md:gap-[46px]">
            ...
            <div className="space-y-[30px]">
              <p className={`${styles.intro} mt-0!`}>
                Thinking about that much needed family holiday this summer? I&apos;m super proud to be partnering once
                again with Sani Resort in Greece to cook-up even more exciting, nutritious dishes for Little Guests.
              </p>
              <p className={`${styles.intro} mt-0!`}>
                Providing a Safe Sanctuary for families in an all-tested environment, why not find your find your
                private spot on a 7km sandy beach or stroll your way to freedom in a 1,000-acre nature reserve?
              </p>
              {/* <img
            ...
            {sectionCards.map((section) => (
              ...
              >
                ...
                <div className="space-y-[20px] text-center lg:text-left">
                  <h2 className={`${styles.cardTitle} italic uppercase`}>{section.title}</h2>
                  <p className={styles.cardExcerpt}>{section.body}</p>
                  <a href={section.buttonHref} target="_blank" rel="noreferrer" className="inline-flex mt-[30px]!">
                    <img src={section.buttonImage} alt={`${section.title} link`} className="w-[250px] max-w-full" />
                  </a>
          ...
          <section className="mt-[72px] space-y-[44px]">
            <div>
              <h2 className={`${styles.cardTitle} italic uppercase`}>REFUEL ON ANNABEL&apos;S EXCLUSIVE MENU</h2>
              <p className={`${styles.cardExcerpt} mt-[24px]`}>
                Annabel invites babies and children of all ages to refuel on her rainbow of fresh and colourful dishes
                across the Resort. Filled with flavour and packed with goodness, Annabel&apos;s delicious recipes will
                bring the whole family together.
              </p>
            </div>
            <a href="https://www.sani-resort.com/en_GB/annabel-karmel" target="_blank" rel="noreferrer">
              <img
                src="/articles/discover-special-offers-at-sani-resort-greece/little-guests-banner.jpg"
          ...
          <section className="mt-[50px] space-y-[44px]">
            <a href="https://www.sani-resort.com/en_GB/your-stay" target="_blank" rel="noreferrer">
              <img
            ...
            <div className="flex justify-center mt-[30px]!">
              <a href="https://www.sani-resort.com/en_GB/your-stay" target="_blank" rel="noreferrer" className="inline-flex">
                <img src="/articles/enjoy-summer-2021-sani-resort-greece/book-now.png" alt="Book now" className="w-[250px] max-w-full" />
              </a>
            </div>
            <div className="flex justify-center mt-[50px]!">
              <a href="https://www.instagram.com/sani_resort_official/" target="_blank" rel="noreferrer">
                <img
