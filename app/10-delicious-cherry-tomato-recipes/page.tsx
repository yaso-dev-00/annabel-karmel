...
const relatedArticles = getRelatedArticles("/10-delicious-cherry-tomato-recipes");
...
const recipes = [
  ...
  },
  {
    ...
    image: "/articles/10-delicious-cherry-tomato-recipes/cherry-tomato-mozzarella-crouton-salad-boats.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/10-delicious-cherry-tomato-recipes/tomato-avocado-bruschetta.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/10-delicious-cherry-tomato-recipes/butternut-squash-tomato-stars.png",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/10-delicious-cherry-tomato-recipes/roasted-piccolo-tomato-sauce.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/10-delicious-cherry-tomato-recipes/chicken-piccolo-tomato-orzo.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/10-delicious-cherry-tomato-recipes/veggie-packed-frittata-muffins.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/10-delicious-cherry-tomato-recipes/chicken-tomato-coconut-curry.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/10-delicious-cherry-tomato-recipes/chicken-tomato-corn-fritters.jpg",
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} md:text-left text-center`}>
            Looking for some fresh and tasty ideas for cooking with our favourite Summer ingredient Piccolo Cherry
            Tomatoes? Look no further than these 10 delicious cherry tomato recipes!
          </p>
          <p className={`${styles.intro}  md:text-left text-center`}>
            From savory main dishes like Chicken &amp; Piccolo Tomato Orzo to kid-friendly snacks like our tomato hummus
            or Frittata muffins, there&apos;s something for everyone in this collection. We&apos;ve even included a
            recipe for Roasted Tomato Sauce that&apos;s perfect for baby&apos;s first tastes. With the versatility and
            flavor of Piccolo tomatoes, these recipes are sure to become new family favorites. So grab some Piccolo
            tomatoes and get ready to cook up a storm with these 10 delicious recipes!
          </p>
