...
export const fourthTrimesterAccordionItems: EggQuestionItem[] = [
  {
    title: 'Slow it down',
    paragraphs: [
  ...
  {
    title: 'Prepare for the night feeds',
    paragraphs: [
  ...
  },
  {
    ...
    closingParagraphs: ['Better out than in we say!'],
  },
  {
    title: 'Manage your visitors',
    paragraphs: [
  ...
  {
    title: 'Look after your nips and bits',
    paragraphs: [
...
export const fourthTrimesterRelatedArticles: RelatedArticleItem[] = [
  {
  ...
  },
  {
    ...
    image: '/articles/weaning-equipment-getting-kitchen-ready-weaning/hero.jpg',
  },
  {
    href: '/top-tips-thinning-baby-purees-2',
    title: 'Top tips for thinning baby purees',
    image: '/articles/top-tips-thinning-baby-purees-2/hero.jpg',
  },
  {
