...
export function withRecipeGridColumnDefaults(data: RecipeGridBlockData): RecipeGridBlockData {
...
export function getRecipeGridStyle(data: RecipeGridBlockData): CSSProperties | undefined {
