      ...
      <main className="overflow-x-hidden bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.introLead}>
            Once your baby has got to grips with those first finger foods when
            baby-led weaning, it's important to continue to introduce a wide
            variety of healthy foods, flavours and textures early on. And here
            are some of Annabel's most popular baby-led weaning recipes with
            young families.
          </p>
          <p className={styles.intro}>
            Remember, baby-led weaning doesn't have to be an all-or-nothing
            method. You can choose to feed your baby soft finger foods and small
            portions of family meals alongside spoon-feeding purees. The
            important thing is that both you and your baby feel content and
          ...
          <p className={styles.intro}>
            ...
            is great, whether you're exclusively baby-led weaning or looking for
            food ideas to feed alongside purees.
          </p>
            ...
            <div className={styles.bannerGrid}>
              ...
              <div className={styles.bannerContent}>
                <p className={styles.bannerText}>
                  Whether you're weaning with purees or taking a baby-led
                  approach, finger foods will be an important part of your
                  baby's feeding journey. But where to start? What finger foods
                  are best for baby?
                </p>
                <p className={styles.bannerText}>
                  Annabel's brand new 30-page guide provides you with everything
                  you need to know for a flying start. And it's FREE!
                </p>
                <a
                  href={GUIDE_URL}
                  target="_blank"
          ...
          <section className="mt-[56px]">
            <h2 className={styles.sectionTitle}>
              Top recipes to get you started on your baby-led weaning journey
            </h2>
          ...
          <section className="mt-[64px] rounded-[6px]  px-5 py-7 text-center md:px-8">
            ...
            <p className={styles.promoText}>
              Annabel Karmel's Baby-Led Weaning Recipe Book is filled with 120
              quick, easy and nutritious recipes, essential advice and tips to
