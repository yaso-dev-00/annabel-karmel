...
export function createDefaultPageContent(category: ProductCategory): ProductPageContent {
  ...
  if (category === "tableware") {
    return {
      ...
      careIcons: [
        ...
        { src: "/tableware/icons/look-icon-3.svg", label: "Freezer safe to -40°c" },
...
export function createDefaultProduct(category: ProductCategory = "chilled-meals"): Product {
