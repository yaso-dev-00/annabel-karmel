import {
  ...
  type EggQuestionItem,
} from '@/components/ArticleScreen/EggQuestionsAccordion';
      ...
      <main className="overflow-x-hidden bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.intro}>
            ...
            baby stage, but weaning offers a real opportunity to bond – and
            it&apos;s a bit of an adventure too!
          </p>
          <p className={styles.bodyText}>
            It can help to establish a routine and have meals around the same
            time each day. To begin with, give just one feed a day, around
            midday, and gradually increase to breakfast, lunch and dinner.
          </p>
          <p className={styles.bodyText}>
            When you start, it can be a good idea to give baby a little milk
            before the solids to stop frustrations arising if he is very hungry
            and struggling to get to grips with the new skills required to
            satisfy his appetite. Always introduce new foods at the beginning of
            the day so that if there is going to be a reaction it is less likely
