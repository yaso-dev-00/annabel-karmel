...
import {
  resolveArticleHref,
  slugFromHref,
} from '@/data/resolve-article-listing';
...
const thumbnailOverrides: Record<string, string> = {
  ...
  '6-tips-for-getting-out-and-about-with-baby':
    '/articles/get-your-free-top-50-first-foods-list/related-6tips.jpg',
  'get-your-free-top-50-first-foods-list':
    '/articles/get-your-free-top-50-first-foods-list/related-first-foods.jpg',
};
