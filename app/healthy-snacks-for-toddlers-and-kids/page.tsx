...
export const metadata: Metadata = {
  title:
    '10 Easy and Healthy Snack Ideas for Toddlers and Kids | Annabel Karmel',
  description:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          ...
          <p className={styles.intro}>
            And if you can make your own, then do, as it’s a good opportunity to
            get the kids involved in the preparation too.
          </p>
