...
export const tablewareFeatures = {
  ...
  columns: [
    ["Durable and long-lasting", "100% premium food grade silicone", "Dishwasher, microwave & freezer safe"],
    [
...
export const tablewareStory = {
  heading: "Introducing baby and toddler tableware for healthy, confident mealtimes",
  paragraphs: [
