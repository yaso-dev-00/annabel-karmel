...
const relatedArticles = getRelatedArticles(
  '/10-easy-bbq-recipes-to-try-this-summer',
);
...
const recipes = [
  ...
  },
  {
    ...
    image:
      '/articles/10-easy-bbq-recipes-to-try-this-summer/chicken-apple-hot-dogs.jpg',
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} md:text-left text-center`}>
            There's nothing quite like firing up the barbecue for family and
            friends on a sunny day. We've rounded up our favourite summer BBQ
            recipes, from Hidden Veg Burgers to Homemade Hot Dogs,
            finger-licking good BBQ Ribs & Apricot Dijon Chicken Drumsticks.
            Look no further, your Summer menu is sorted.
          </p>
