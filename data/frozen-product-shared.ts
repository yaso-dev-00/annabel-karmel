...
export const chickenTomatoMascarponePastaBadges = [
  ...
  { src: `${chickenPastaBase}/icons/artboard-2.svg`, alt: "Packed with veggies" },
  { src: `${chickenPastaBase}/icons/artboard-2-5.svg`, alt: "Locked in goodness" },
  {
    src: `${chickenPastaBase}/icons/artboard-2-9.svg`,
    alt: "No artificial colours or preservatives",
  },
  { src: `${chickenPastaBase}/icons/artboard-4.svg`, alt: "Ready in 5 mins from frozen" },
  { src: `${chickenPastaBase}/icons/artboard-3-4.svg`, alt: "Approved by tots and kids" },
];
