...
export function RecipeSchemaFields({ schema = {}, onChange }: RecipeSchemaFieldsProps) {
  const patch = <K extends keyof RecipeSchema>(key: K, value: RecipeSchema[K]) => {
  ...
  return (
    <div className="cardForm">
      ...
      <div className="field">
        ...
        <p className={styles.fieldHint}>Use format e.g. PT15M (indicates 15 min)</p>
        <input
