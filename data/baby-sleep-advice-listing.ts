...
function toListingArticle(article: BabySleepAdviceArticle): AdviceCategoryListingArticle {
  return {
    title: article.title,
...
export const babySleepAdviceListingArticles = babySleepAdviceArticles.map(toListingArticle);
...
export function babySleepAdviceRelatedArticles(_excludeSlug: string): RelatedArticleItem[] {
