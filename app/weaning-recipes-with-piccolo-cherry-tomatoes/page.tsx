...
const relatedArticles = getRelatedArticles("/weaning-recipes-with-piccolo-cherry-tomatoes");

const recipes = [
  {
    title: "Hidden Vegetable Tomato Sauce",
    href: "https://www.annabelkarmel.com/recipes/hidden-vegetable-tomato-sauce/",
    image: "/articles/weaning-recipes-with-piccolo-cherry-tomatoes/hidden-vegetable-tomato-sauce.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/weaning-recipes-with-piccolo-cherry-tomatoes/chicken-tomato-coconut-curry.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/weaning-recipes-with-piccolo-cherry-tomatoes/chicken-tomato-corn-fritters.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/weaning-recipes-with-piccolo-cherry-tomatoes/cherry-tomato-mascarpone-risotto.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/weaning-recipes-with-piccolo-cherry-tomatoes/spinach-tomato-frittata.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/weaning-recipes-with-piccolo-cherry-tomatoes/mini-cherry-tomato-cheese-muffins.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/weaning-recipes-with-piccolo-cherry-tomatoes/cherry-tomato-squash-spinach-orzo.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/weaning-recipes-with-piccolo-cherry-tomatoes/salmon-sweet-potato-tomato-puree.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/weaning-recipes-with-piccolo-cherry-tomatoes/sweetcorn-tomato-rainbow-fritters.jpg",
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro}   text-center`}>
            The possibilities of what to do with Piccolo Cherry Tomatoes are endless, they're almost tomatoo good
            to be true - especially when it comes to weaning your little one!
          </p>
          <p className={`${styles.intro}  text-center`}>
            Piccolos are rich in Vitamins E, C and K, as well as being a valuable source of the antioxidant
            lycopene - and not to mention seriously delicious!
          </p>
          <p className={`${styles.intro}   text-center`}>
            It's remarkable how your baby suddenly transforms into a top detective at mealtimes, scrupulously on
            the hunt for signs of veggies.
          </p>
          <p className={`${styles.intro}  text-center`}>
            But what I've discovered is that while little ones think they don't like vegetables, they really just
            don't like the look of them!
          </p>
          <p className={`${styles.intro}   text-center`}>
            So here are some brand new weaning recipes to try our on your tiny taster.
          </p>
