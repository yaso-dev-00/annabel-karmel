      ...
      <main className="overflow-x-hidden bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.intro}>
            Mums have trusted Annabel Karmel recipes for years, but which of her
            recipes are the most popular? Below we count down through the top 10
            most popular baby recipes on our website in 2019.
          </p>
          ...
          <p className={styles.question}>
            Which of our most popular baby recipes is your favourite?
          </p>
