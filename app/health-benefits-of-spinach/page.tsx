      ...
      <main className="overflow-x-hidden bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-3 pb-6 pt-6 md:px-6 md:pb-10 md:pt-8">
          <p className={styles.introLead}>
            It&apos;s no secret that spinach is one serious superfood! It contains a whole host of antioxidants to help
            build and strengthen your little one&apos;s immune system. An excellent source of vitamins and minerals
            including vitamin A, C, and K as well as a source of iron, folic acid, and calcium, it provides a boost of
            calcium for bone health too.
          </p>
          <p className={styles.intro}>
            But, we all know that green veggies like spinach are not always a firm &apos;favourite&apos; for babies and
            young children. However, it&apos;s easy to serve spinach in a whole host of different ways to make them
            slightly more appealing – I hope these spinach recipes help to inspire!
          </p>

          <h1 className={styles.recipesMainTitle}>Spinach Recipes:</h1>
          <p className={styles.waysSubtitle}>Four ways with spinach</p>

          <section className="mt-10 md:mt-12" aria-labelledby="recipe-spinach-puree">
            ...
            <p className={styles.caption}>
              Boost your baby&apos;s strength with this superfood puree recipe, loaded with spinach.
            </p>
          </section>

          <hr className={styles.divider} />

          <section className="mt-10 md:mt-12" aria-labelledby="recipe-spinach-frittata">
            ...
            <p className={styles.caption}>
              Eggs are high in protein and contain iron, folate and vitamin A – so serve up this power-packed frittata
              for breakfast.
            </p>
          </section>
          ...
          <section className="mt-10 md:mt-12" aria-labelledby="recipe-shell-pasta">
            ...
            <p className={styles.caption}>
              A tasty veggie pasta sauce ready in minutes. You can make this using my organic baby pasta shells which
              are a great way to introduce more texture into your baby&apos;s food. My organic pasta shells are now
              available to buy on{" "}
              <a href={OCADO_PASTA} className={styles.inlineLink} target="_blank" rel="noopener noreferrer">
                Ocado
              </a>{" "}
              &amp;{" "}
              <a href={AMAZON_PASTA_SEARCH} className={styles.inlineLink} target="_blank" rel="noopener noreferrer">
                Amazon
              </a>
              .
            </p>
          ...
          <section className="mt-10 md:mt-12" aria-labelledby="recipe-wraps">
            ...
            <p className={styles.caption}>
              Pop some veggies inside a wrap and suddenly it adds oodles of child appeal. This is a quick and tasty
              combination and you can add other ingredients like chopped cherry tomatoes, spring onion or swap the
              chicken for tuna.
            </p>
          </section>
