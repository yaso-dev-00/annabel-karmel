...
const childHealthArticles: ChildHealthArticle[] = [
  ...
  },
  {
    ...
    imageAlt: "Gagging vs Choking: The differences you need to know when weaning your baby",
  },
  {
  ...
  },
  {
    ...
    imageAlt: "10 things you need to know about looking after your children's teeth",
  },
  {
...
function toListingArticle(article: ChildHealthArticle): AdviceCategoryListingArticle {
  return {
    title: article.title,
...
export const childHealthDevelopmentArticles = childHealthArticles.map(toListingArticle);
