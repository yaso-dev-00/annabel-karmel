...
export const babyBedtimeSections: SleepAdviceSection[] = [
  ...
  },
  {
    ...
    tableRows: [
      {
        label: '6 months and younger',
        value: "3-4 hours' sleep over 3 to 4 naps",
      },
      ...
      {
        label: '3 to 5 years',
        value: 'Sometimes 1 nap (most lose between 3 & 5)',
      },
    ],
  },
  {
    ...
    tableRows: [
      {
        ...
        value:
          'Keep to their nap gap. So if they go 2 hours between naps during the day, ensure bedtime is no more than 2 hours from their last nap of the day',
      },
      {
        label: '6 months to 18 months',
        value: 'Ideally no more than 4 hours from 3pm',
      },
      {
...
export const babyBedtimeRelatedArticles =
