...
export const newsletterBarContent = {
  desktopText:
    "Join Annabel's newsletter for exclusive recipes, competitions, offers and more!",
  mobileText: 'Exclusive recipes, competitions and more',
  closeIconUrl:
    'https://www.annabelkarmel.com/wp-content/uploads/2025/03/Close-optimized.png',
};

export const newsletterPopupContent = {
  title: "Join Annabel's newsletter",
  subtitle:
    'Be the first to hear about new competitions, recipes, offers and more!',
...
export const siteAdBanners: SiteAdBanner[] = [
  {
    ...
    image:
      'https://www.annabelkarmel.com/wp-content/uploads/2026/05/Ad-banner-4-1.png',
  ...
  },
  {
    ...
    image:
      'https://www.annabelkarmel.com/wp-content/uploads/2026/06/Gruffalo-Comp-June-2026.png',
  ...
  },
  {
    ...
    image:
      'https://www.annabelkarmel.com/wp-content/uploads/2026/06/App-Leaderboard-June-2026.png',
