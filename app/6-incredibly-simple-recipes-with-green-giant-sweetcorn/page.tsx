...
const relatedArticles = getRelatedArticles(
  '/6-incredibly-simple-recipes-with-green-giant-sweetcorn',
);
...
const recipes = [
  {
    ...
    image:
      '/articles/6-incredibly-simple-recipes-with-green-giant-sweetcorn/slice-of-fun-sweetcorn-rosti-pizza.webp',
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} text-center`}>
            Annabel proudly presents a brand-new collection of recipes featuring
            the wholesome goodness of Green Giant sweetcorn.
          </p>
          <p className={`${styles.intro} text-center`}>
            From those first exploratory bites to delightful family feasts, our
            specially crafted recipes cater to every stage of your child&apos;s
            growth and palate development.
          </p>
          <p className={`${styles.intro} text-center`}>
            Bursting with vibrant flavours, essential nutrients, and the
            unmistakable freshness of Green Giant sweetcorn, these dishes are
            designed to ignite a lifelong love for delicious, nourishing food.
          </p>
          <p className={`${styles.intro} text-center`}>
            Whether you&apos;re a parent looking to introduce your little one to
            the world of solids or a family seeking delightful mealtime
            experiences, join us in discovering the magic that Green Giant
            sweetcorn brings to the table.
          </p>
