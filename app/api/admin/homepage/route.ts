...
import { getHomepageDocument, updateHomepageDocument } from "@/lib/admin/homepage-store";
...
export async function PUT(request: Request) {
  try {
    const body = (await request.json()) as Partial<Omit<HomepageDocument, "id" | "created_at">>;
