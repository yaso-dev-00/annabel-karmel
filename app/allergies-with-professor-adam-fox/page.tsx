import { AdamFoxAllergiesAccordion } from "@/components/adam-fox-allergies-accordion";
...
const relatedArticles = getRelatedArticles("/allergies-with-professor-adam-fox");
...
const accordionItems = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      {
        intro: "Symptoms of an immediate food allergy: Mild to moderate symptoms typically affect the skin, the respiratory system, and the gut.",
        bullets: [
      ...
      { emphasis: "Severe symptoms (Anaphylaxis): These require urgent medical attention.", compact: true },
      {
        intro: "",
        bullets: [
        ...
        <article className="mx-auto w-full max-w-[1200px] mt-[50px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.intro}>
            <strong>
              ...
              <a href="https://www.annabelkarmel.com/advice/allergy-specialist/" target="_blank" rel="noopener" className={styles.link}>
                Professor Adam Fox
              </a>{" "}
          ...
          <p className={styles.body}>
            Childhood food allergies seem to be on the increase, so it&apos;s natural that you might be nervous about
            introducing foods that could cause problems.
          </p>
          <p className={styles.body}>
            However, it&apos;s worth noting that the actual incidence of food allergy in babies is very small - about
            6%. Many babies grow out of allergies like cow&apos;s milk allergy by the age of two or three.
          </p>
          <p className={`${styles.body} mb-[50px]!`}>
            Food allergies are more common among babies and children from families with a history of food allergy.
            Babies who suffer from eczema are also at risk of suffering from food allergies. Babies who develop severe
            eczema before the age of three months are at very high risk, so you need to be particularly cautious when
