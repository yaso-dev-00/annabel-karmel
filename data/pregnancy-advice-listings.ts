...
export function toPregnancyListingArticle(
  article: PregnancyAdviceArticle,
...
export const pregnancyTipsArticles =
  pregnancyArticlesForCategory('pregnancy-tips');
export const yourPregnancyArticles =
  pregnancyArticlesForCategory('your-pregnancy');
