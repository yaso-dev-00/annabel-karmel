...
import {
  FoodAllergiesFaqAccordion,
  type FoodAllergiesFaqItem,
} from '@/components/ArticleScreen/FoodAllergiesFaqAccordion';
...
const articlePath =
  '/articles/food-allergies-your-common-questions-concerns-answered';
...
const qaItems: FoodAllergiesFaqItem[] = [
  ...
  {
    question:
      'My child has a dairy allergy which causes sleepless nights - how do you deal with it?',
  ...
  {
    question:
      'If you have an allergy to both milk and eggs, do you do ladders at the same time?',
  ...
  {
    question:
      "If a child is allergic to cow's milk, what would you recommend post 12 months?",
  ...
  {
    question:
      'If a child is allergic to peanuts, should I avoid tree nuts like cashew nuts, pecans or walnuts?',
  ...
  return (
    <>
      ...
      <main className="bg-white">
        <article
          className={`mx-auto mt-[20px] w-full max-w-[1200px] px-[8px] pb-[10px] pt-[16px] sm:px-[12px] md:mt-[40px] md:px-[14px] md:pt-[20px] ${styles.articleShell}`}
        >
          <p className={styles.intro}>
            Childhood food allergies are on the increase, so it&apos;s natural
            that you might be nervous about introducing potentially allergenic
            foods, such as eggs, peanuts, gluten, to your baby early on. Finding
            support for your child or for yourself can be quite challenging
            &amp; expensive, so we&apos;ve teamed up with Dr Jose Maia Costa,
            Paediatric allergy consultant, who has answered some of the most
            commonly asked question around food allergies in the article below.
          </p>
            ...
            <div className="grid grid-cols-1 gap-8 text-left md:grid-cols-2 md:items-center">
              <div>
                <h2 className={styles.sectionTitle}>
                  Track your child&apos;s Allergies with Annabel&apos;s Allergy
                  Tracker
                </h2>
                <hr className="text-[#cccccc] mt-[20px] " />
                <p className={styles.body}>
                  Understandably, lots of families have concerns over allergies,
                  particularly when first weaning. Annabel&apos;s helpful
                  Allergy Tracker tool on her best-selling recipe App will help
                  you track and record any symptoms arising from eating certain
                  foods. Having this information in one place will be invaluable
                  when sharing any concerns with your GP or doctor.
                </p>
                <p className={styles.body}>
                  To help further support families with allergies,
                  Annabel&apos;s new and refreshed app includes even more
                  free-from recipes which are clearly signposted.
                </p>
              </div>
              <div>
                <FallbackImage
          ...
          <section className={styles.doctorSection}>
            ...
            />
            <h3 className={styles.doctorHeading}>
              Article contributed by Dr Jose Costa, paediatric allergy
              consultant
            </h3>
            <p className={styles.doctorBody}>
              <strong>Dr Jose Costa</strong> runs several allergy clinics
              focusing on the diagnosis and management of Food Allergy,
              Hayfever, Allergic Rhinitis, Chronic Spontaneous Urticaria and
              Angioedema, Eczema, Asthma and MCAS. He’s a member of the Royal
              College Of Paediatrics and Child Health and the British Society of
              Allergy and Clinical Immunology. His primary focus of interest in
              Allergy is in immunotherapy and desensitization.
            </p>
            <p className={styles.doctorBody}>
              José is the co-author of a study titled “Increase in Multiple Nut
              Reactivity with Increasing Age is Not an Artefact of Incomplete
              Allergy Testing”, which explored the introduction of nuts into an
              infant/child’s diet. This research found that not introducing nuts
              that children are not allergic to will increase their risk of
              developing allergy to those nuts later in life.
            </p>
            <p className={styles.doctorBody}>
              If you think your child might be suffering from an allergy, please
              don’t hesitate to get Dr Jose to book an initial allergy
              consultation so he can start to identify their symptoms and
              diagnose the issue.
            </p>
            <p className={styles.doctorBody}>
              For more information visit{' '}
              <a
                href="https://www.thechildrensallergy.co.uk/"
                target="_blank"
                rel="noopener"
