...
export const articleSlug = "potty-training";
export const articlePath = `/articles/${articleSlug}`;

export const pottyTrainingIntro =
...
export const pottyTrainingAccordionItems: FoodCategoryItem[] = [
  {
    title: "Signs your child is ready",
    paragraphs: [
...
export const pottyTrainingRelatedArticles: RelatedArticleItem[] = [
  {
