      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={`${styles.intro} mt-[20px]!`}>
            It&apos;s a good idea to progress from purees after a short while,
            not just because life has more to offer than things that can be
            sucked through a straw, but because chewing helps develop the same
            muscles needed for speech. Gradually introduce thicker purees, as
            well as mashed, grated and chopped food. Tiny pasta shapes are a
            great way to thicken things up. It&apos;s surprising what gums can
            get through so don&apos;t think you need to wait for a set of teeth
            to appear.
          </p>
          ...
          <div className="mt-[28px]">
            <FoodCategoryAccordion
              ...
              defaultOpenTitle="RED MEAT"
            />
          </div>

          <h2 className={styles.recipeHeading}>
            Recipes to start introducing texture:
          </h2>
