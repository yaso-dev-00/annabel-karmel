...
export const familyHealthAccordionItems: FoodCategoryItem[] = [
  {
    ...
    subsections: [
      ...
      {
        heading: "2- If back blows do not dislodge the object, give up to five chest thrusts.",
        paragraphs: [
      ...
      {
        heading: "1- Give up to five back blows.",
        paragraphs: ["Hit them firmly on their back between the shoulder blades."],
      },
      {
        heading: "2- If back blows do not dislodge the object, give up to five abdominal thrusts.",
        paragraphs: [
  ...
  },
  {
    ...
    subsections: [
      ...
      {
        heading: "1- Cool the burn under cold running water for at least ten minutes.",
        paragraphs: [],
      },
      {
        heading: "2- After the burn has cooled, cover it with cling film or a clean plastic bag.",
        paragraphs: [],
      },
      {
  ...
  {
    title: "Asthma attack",
    paragraphs: ["A baby or child having an asthma attack will wheeze and find it difficult to breathe."],
    subsections: [
      {
        heading: "1- Help the baby or child to sit in a comfortable position and take their medication.",
        paragraphs: [],
      },
      {
        heading: "2- Stay calm and reassure them.",
        paragraphs: ["If they don't have their medication or the attack becomes severe call 999."],
      },
    ],
  },
  {
    ...
    subsections: [
      {
        ...
        paragraphs: ["The emergency services will want to know this information."],
      },
      {
        heading: "2- Call 999.",
        paragraphs: [
  ...
  },
  {
    ...
    subsections: [
      ...
      {
        heading: "3-Once the seizure has ended help them to rest on their side with their head tilted back.",
        paragraphs: ["If this is their first seizure or the symptoms continue seek medical advice."],
      },
    ],
  },
];
