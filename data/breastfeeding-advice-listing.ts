...
export const breastfeedingAdviceArticles: BreastfeedingAdviceArticle[] = [
  ...
  },
  {
    ...
    imageAlt:
      'Myths about breastfeeding and breast milk busted by Annabel Karmel',
  },
  {
...
function toListingArticle(
  article: BreastfeedingAdviceArticle,
...
export const breastfeedingAdviceListingArticles =
  breastfeedingAdviceArticles.map(toListingArticle);
