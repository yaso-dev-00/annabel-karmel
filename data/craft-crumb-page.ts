export const craftCrumbLinks = {
  tescoSearch: "https://www.tesco.com/groceries/en-GB/search?query=craft+%26+crumb&inputType=free+text",
...
export const craftCrumbProducts: CraftCrumbProduct[] = [
  {
    ...
    body:
      "Hickory, Dickory, Dock…get ready, it's bake o'clock! You'll have little ones scurrying to the kitchen with our mischievous muffins, complete with cute rocking mice craft.",
  ...
  },
  {
    ...
    body:
      "No teddy bears' picnic would be complete without a batch of beary tasty cookies. Complete with a make-your-own tray for sharing, it's time for a pawesome kitchen adventure.",
  ...
  },
  {
    ...
    body:
      "Let little imaginations run free with these roarsome animal print biscuits! Packed with all natural ingredients, this tasty adventure is perfect for little paws with wild imaginations. Get ready for a biscuit tin stampede – these treats won't last long!",
