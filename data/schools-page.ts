...
export const articleSlug = 'schools';
...
export const schoolsAccordionItems: FoodCategoryItem[] = [
  {
  ...
  {
    title: "Getting to know your child's new teacher",
    paragraphs: [
...
export const schoolsRelatedArticles: RelatedArticleItem[] = [
  {
