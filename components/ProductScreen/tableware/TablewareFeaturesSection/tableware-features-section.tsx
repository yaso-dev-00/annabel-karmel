...
import styles from "@/components/ProductScreen/tableware/TablewarePage/tableware-page.module.css";
...
type TablewareFeaturesSectionProps = {
  heading: string;
  columns: string[][];
  headingId?: string;
};

export function TablewareFeaturesSection({
  heading,
  columns,
  headingId = "tableware-features-heading",
}: TablewareFeaturesSectionProps) {
  return (
    <section className={styles.featuresSection} aria-labelledby={headingId}>
      <div className={styles.featuresCard}>
        ...
        <img
          ...
          decoding="async"
        />
        <h2 id={headingId} className={styles.featuresHeading}>
          {heading}
        </h2>
