...
const relatedArticles = getRelatedArticles("/annabels-6-family-favourites-with-heck");

const recipes = [
  {
    title: "Hidden Veg Chicken Bolognese",
    href: "https://www.annabelkarmel.com/recipes/hidden-veg-chicken-bolognese/",
    image: "/articles/annabels-6-family-favourites-with-heck/hidden-veg-chicken-bolognese.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/annabels-6-family-favourites-with-heck/crispy-cornflake-chicken-burger.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/annabels-6-family-favourites-with-heck/sticky-sausage-veg-traybake.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/annabels-6-family-favourites-with-heck/cheesy-sausage-veg-pasta.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/annabels-6-family-favourites-with-heck/sausage-potato-frittata-muffins.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/annabels-6-family-favourites-with-heck/mini-toad-in-the-hole.jpg",
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} text-center`}>
            Annabel has joined forces with HECK! a wonderful family-run company crafting sausages & burgers in small
            batches right from their farm in Yorkshire.
          </p>
          <p className={`${styles.intro}  text-center`}>
            Here you'll find Annabel's x HECK! family-friendly recipes that are not only incredibly scrumptious but
            also designed to make your life in the kitchen a breeze.
          </p>
          <p className={`${styles.intro}  text-center`}>
            Each recipe is a testament to the exceptional range of products offered by HECK!, guaranteeing a
            mouthwatering experience for your entire family. Get ready to elevate your cooking game with the perfect
            combination of Annabel's easy-to-follow recipes and HECK's outstanding products!
          </p>
