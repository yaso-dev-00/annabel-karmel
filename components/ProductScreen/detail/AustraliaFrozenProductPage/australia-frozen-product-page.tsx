  ...
  return (
    <main className={styles.page} style={pageStyle}>
      ...
      <section className={styles.woodBand} aria-label={data.title}>
        <div className={styles.pageContainer}>
          <div className={styles.splitGrid}>
            <div
              className={`${styles.splitTile} ${styles.tileCarousel} order-1 md:order-1`}
            >
              <ProductCarousel slides={data.carousel} />
            </div>
            <div
              className={`${styles.splitTile} ${styles.tileDescription} order-2 md:order-2`}
            >
      ...
      <section
        ...
        aria-labelledby="au-product-range-heading"
      >
        <div className={`${styles.pageContainerPadded} ${styles.rangeSection}`}>
          ...
          <p className={styles.rangeSubtitle}>
            {australiaFrozenProductRange.subtitle}
          </p>
      ...
      <section
        className={styles.woodBand}
        aria-labelledby="au-product-promise-heading"
      >
        <div className={styles.pageContainer}>
          <div className={styles.splitGrid}>
      ...
      <section className={styles.woodBand} aria-label="Product information">
        <div
          className={`${styles.pageContainerPadded} ${styles.accordionSection}`}
        >
      ...
      <div
        className={`${styles.pageContainerPadded} ${styles.retailerSectionBottom}`}
      >
        <RetailerLogos retailers={retailers} />
      </div>
