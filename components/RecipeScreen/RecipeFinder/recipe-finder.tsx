...
export function RecipeFinder({
  ...
  const handleReset = () => {
    setQ("");
    setAge(isArchive ? "" : taxonomy?.kind === "recipe-category" ? taxonomy.slug : "");
    setMealTime(isArchive ? "" : taxonomy?.kind === "meal-time" ? taxonomy.slug : "");
    setFreeFromSlug(isArchive ? "" : taxonomy?.kind === "allergen" ? taxonomy.slug : "");
