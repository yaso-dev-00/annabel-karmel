...
const toddlerTips: { id: string; content: React.ReactNode }[] = [
  ...
  },
  {
    ...
    content: (
      <>
        Sing a song with them whilst they wash their hands. Hands should be
        washed for 20 seconds which is enough time to sing &lsquo;Happy
        Birthday&rsquo; <u className="underline">twice</u>, but you could always
        sing along to a nursery rhyme or any other song your child loves to make
        sure they stay at the sink long enough! If you&apos;re stuck for song
        ideas… check out the collaboration between the World Health Organisation
        and Peppa Pig{' '}
        <a
      ...
      <main className="bg-white">
        <article className="mx-auto mt-[18px] w-full max-w-[1200px] px-[10px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.bodyNoTop}>
            Anyone who has begun weaning their little one can sympathise it gets
            MESSY! But what about cleaning your baby <strong>before</strong>{' '}
            mealtimes?
          </p>
          <p className={styles.body}>
            We should always wash our own hands before eating and babies&apos;
            hands are no different... especially once they are old enough to
            start eating, crawling and getting into all sorts of mischief! Hand
            washing is the simplest, yet most effective way to stop the spread
            of bacteria and therefore keep our babies safe and protected from
            illnesses.
          </p>
          <p className={styles.body}>
            For some tips on washing your baby&apos;s hands; including the
            logistics and what to use on baby&apos;s skin, I&apos;ve answered
            some of the common hand washing questions below....
          </p>
          ...
          />
          <p className={styles.body}>
            One of the most straightforward ways to wash your baby&apos;s hands
            is of course to hold your baby over the sink, position them on your
            knee and wash their hands with soap and water as you would your own
            (being careful not to press little one&apos;s tummy into the sink
            whilst doing so).
          </p>
          <p className={styles.body}>
            However, if the logistics of doing this isn&apos;t for you
            (especially when your baby is little), then you can also apply soap
            to their hands using a dampened soapy washcloth instead, using
            another cloth dampened with just water to wipe away the soap.
          </p>
          <p className={styles.body}>
            Remember you can also put the bowl of soapy water in front of baby
            or toddler and use a cloth to make sure you get in between all of
            their fingers, again using a damp cloth after washing to clean off
            the soapy residue.
          </p>
          <p className={styles.body}>
            Just make sure when you&apos;re drying their hands, the towel is
            clean and dry.
          </p>
          ...
          <p className={styles.bodyNoTop}>
            Soap and water are always best to wash hands with... regardless of
            age!
          </p>
          <p className={styles.body}>
            However, if you&apos;re worried that your regular kitchen soap might
            be a little too harsh for your baby&apos;s delicate skin, then you
            can always use some of their body wash instead when they are little!
            Truth is.... anything &lsquo;soapy&rsquo; will do the job when it
            comes to handwashing providing hands are washed thoroughly!{' '}
          ...
          <p className={styles.bodyNoTop}>
            When out and about, always stick to using soap and water whenever
            and wherever you can.
          </p>
          <p className={styles.body}>
            However, if there is no soap and water available, hand sanitiser may
            be used if there is no alternative but make sure you rub it in until
            completely dry. Just be aware that hand sanitisers do not work as
            well as soap and water
            <a id="_ftnref2" href="#_ftn2">
              [2]
            </a>
            , particularly against germs such as Norovirus
            <a id="_ftnref3" href="#_ftn3">
              [3]
            </a>{' '}
            or if hands are physically dirty or greasy, so you may want to wipe
            your little ones&apos; hands with a damp wipe first.
          </p>
          ...
          />
          <p className={styles.body}>
            It is really important to embed a good hand washing routine as early
            on in life as possible. As your baby progresses into a toddler,
            it&apos;s important to change your hand washing technique as they
            grow, keeping it fun whilst giving them lots of praise and
            encouragement! Here&apos;s some ideas how you can start getting your
            toddler involved in washing their hands and help them to understand
            that it&apos;s an important part of their daily routine...
          </p>
          ...
          <p className={styles.body}>
            .. And don&apos;t forget to also wash your hands at the same time!
            Not only will this help keep everyone safe, but seeing you lead by
            example will be a great learning tool for your little one from any
            age.
          </p>
