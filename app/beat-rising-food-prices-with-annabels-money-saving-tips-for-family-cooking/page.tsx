...
const relatedArticles = getRelatedArticles("/beat-rising-food-prices-with-annabels-money-saving-tips-for-family-cooking");

const sections = [
  {
    title: "Batch cook",
    image: "/articles/beat-rising-food-prices-with-annabels-money-saving-tips-for-family-cooking/batch-cook.jpg",
  ...
  },
  {
    ...
    image: "/articles/beat-rising-food-prices-with-annabels-money-saving-tips-for-family-cooking/plan-meals.jpg",
  ...
  },
  {
    ...
    image: "/articles/beat-rising-food-prices-with-annabels-money-saving-tips-for-family-cooking/make-the-most-of-meat.jpg",
  ...
  },
  {
    ...
    image: "/articles/beat-rising-food-prices-with-annabels-money-saving-tips-for-family-cooking/maximising-leftovers.jpg",
  ...
  },
  {
    ...
    image: "/articles/beat-rising-food-prices-with-annabels-money-saving-tips-for-family-cooking/seasonal-for-the-win.jpg",
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px]  pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.body}>
            Providing for our families can be challenging at the best of times, but throw a global pandemic, inflation,
            and increased costs of living into the mix and it's enough to get you into a stew. But fret not, there are
            many ways to cut costs not quality and feed the family on a budget, including batch-cooking hearty, staple
            meals... like stew incidentally!
          </p>
          ...
          <div className="mt-[10px] grid grid-cols-1 gap-[30px]">
            {sections.map((section) => (
              <section key={section.title}>
                ...
                <img src={section.image} alt={section.title} className="mt-[20px] md:mt-[10px]  w-full" />
              
                <p className={`${styles.body} mt-[14px]`}>{section.body}</p>
                {"body2" in section && section.body2 ? <p className={`${styles.body} mt-[14px]`}>{section.body2}</p> : null}
                {"body3" in section && section.body3 ? <p className={`${styles.body} mt-[14px]`}>{section.body3}</p> : null}
              </section>
            ))}
          </div>

          <section className="mt-[44px]">
            <h2 className={styles.ctaHeading}>Save time & money with Annabel's new cookbook!</h2>
            <div className="mt-[25px] grid grid-cols-1 gap-[14px] min-[950px]:grid-cols-2">
              ...
              <p className={`${styles.body} mt-[5px]!`}>
                Annabel's Fun, Fast & Easy Children's Cookbook is the brand-new kitchen companion for young children and
                the whole family from international best-selling author, Annabel Karmel. Filled with easy-to-make
                recipes, fascinating foodie facts, cooking tips and kitchen tricks, this is the essential guide to get
                kids in the kitchen. With a focus on fresh, wholesome ingredients and complete with simple step-by-step
                instructions, it's the perfect way to teach children essential kitchen skills and develop a life-long
                love of good food.
              </p>
            </div>
