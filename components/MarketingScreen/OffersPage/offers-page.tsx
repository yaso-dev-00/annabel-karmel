      ...
      <p className={styles.offerPriceLine}>
        <strong>
          ...
          <span className="font-[500]">
            {offer.nowSuffix ? ` ${offer.nowSuffix}` : null}
          </span>
        </strong>
      </p>
      ...
      <a
        ...
        className={`${styles.shopButton} ${
          buttonVariant === 'chilled'
            ? styles.shopButtonChilled
            : styles.shopButtonFrozen
        }`}
      >
        SHOP NOW
      </a>
  ...
  return (
    <main className={styles.page}>
      ...
      <section
        ...
        aria-label="Family enjoying Annabel Karmel meals"
      >
        <img
      ...
      <section
        className={`${styles.fullBleed} ${styles.woodSection} ${styles.introSection}`}
      >
        <div className={styles.inner}>
      ...
      <section
        className={`${styles.fullBleed} mt-[30px] md:mt-[40px]`}
        aria-label="Supermarket offers"
      >
      ...
      <section
        className={`${styles.fullBleed} ${styles.awardSection}`}
        aria-labelledby="offers-award-heading"
      >
      ...
      <section
        className={styles.fullBleed}
        aria-label="Discover our meal ranges"
      >
        <div className="grid grid-cols-1 gap-[20px]  md:grid-cols-2">
