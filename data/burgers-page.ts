...
export const burgersPageData: PlantPoweredBitesPageData = {
  ...
  carousel: [
    { src: `${assetBase}/carousel-1.png`, alt: "Burger carousel 1", width: 800, height: 800 },
    { src: `${assetBase}/carousel-2.png`, alt: "Burger carousel 3", width: 800, height: 800 },
    { src: `${assetBase}/carousel-3.png`, alt: "Burger carousel 2", width: 800, height: 800 },
    { src: `${assetBase}/carousel-4.png`, alt: "Burgers carousel 4", width: 800, height: 800 },
  ],
  badges: {
