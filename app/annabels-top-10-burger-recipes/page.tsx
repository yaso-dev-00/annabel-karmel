...
const recipes = [
  ...
  },
  {
    ...
    image: "/articles/annabels-top-10-burger-recipes/hidden-veg-burgers-sweet-potato-fries.jpg",
    excerpt:
  ...
  },
  {
    ...
    image: "/articles/annabels-top-10-burger-recipes/my-favourite-vegan-burger.jpg",
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} text-center md:text-left`}>
            Introducing Annabel&apos;s Top 10 Burger Recipes! Get ready to elevate your burger game with these
            mouthwatering creations. From classic favourites to bold and innovative combinations, Annabel has curated a
            collection of burger recipes that will tantalize your taste buds.
           Whether you&apos;re a meat lover or prefer plant-based alternatives, there&apos;s something for everyone in
          this burger extravaganza. Unleash your culinary creativity and satisfy your cravings with Annabel&apos;s Top 10 Burger Recipes today!
          </p>
