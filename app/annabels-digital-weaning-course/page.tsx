      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <h1 className={styles.title}>
            Annabel&apos;s Digital Weaning Course
          </h1>

          <p className={`${styles.body} mt-[22px]`}>
            Set your baby up for a lifetime of healthy, happy eating with your
            complete Digital Weaning Course from Annabel Karmel.
          </p>
          <p className={`${styles.body} mt-[8px]`}>
            Designed with an expert team of registered dietitians and
            nutritionists, Annabel&apos;s step-by-step online audio course
            provides you with the ultimate guide to feeding your baby
            confidently.
          </p>
          ...
          <p className={`${styles.body} mt-[20px]`}>
            ...
            <a
              href="https://www.annabelkarmelweaning.com"
              target="_blank"
              rel="noopener"
