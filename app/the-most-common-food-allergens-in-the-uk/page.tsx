...
export const metadata: Metadata = {
  title:
    'The most common food allergens in the UK | Nutrition | Annabel Karmel',
  description:
        ...
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[16px] sm:px-[12px] md:mt-[40px] md:px-[14px] md:pt-[20px]">
          <div className="mx-auto">
            <p className={styles.bodyText}>
              There are 14 major allergens which must be clearly mentioned on
              food labels or on information such as restaurant menus when they
              are used as ingredients in a food product or meal. These reflect
              the most common food allergens across Europe. Some of these, such
              as mustard and celery are uncommon in the UK whilst others e.g.
              sulphur dioxide are not important in babies.{' '}
            ...
            <p className={styles.bodyText}>
              Here is your guide to the allergens to watch out for, and some
