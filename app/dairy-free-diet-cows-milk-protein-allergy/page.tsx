import { DairyFreeFaqAccordion } from "@/components/dairy-free-faq-accordion";
...
const faqItems = [
    ...
    ]  },
  {
    ...
    paragraphs: ["Contrary to popular belief, eggs are not dairy foods and so can be eaten by your baby if she has a milk allergy. I’ve never seen a cow lay an egg!"],
  },
  {
    ...
    paragraphs: [
      {
        segments: [
          ...
          { label: "Milk Ladder", href: "https://www.annabelkarmel.com/milk-ladder/" },
    ...
    <>
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          ...
          <h2 className={styles.sectionTitle}>Why might your baby need a dairy free diet?</h2>
          <img src={`${articlePath}/why-dairy-free.jpg`} alt="Baby with bottle" className="mt-[20px] w-full" />
          <p className={styles.body}>
            Your healthcare professional may have suggested that your baby needs a dairy free diet if they have symptoms
            of a cow&apos;s milk protein allergy or intolerance.
          </p>
          <p className={styles.body}>
          ...
          <img src={`${articlePath}/how-diagnosed.jpg`} alt="Doctor with baby" className="mt-[20px] w-full" />
          <p className={styles.body}>
            Immediate onset allergies can be diagnosed by skin prick tests where a small amount of the suspected
            allergen food is put on your baby&apos;s skin. The surface of the skin is then scratched and the size of
            the wheel it creates is measured. Alternatively, a blood sample can be taken and sent off for further
            analysis.
          </p>
          <p className={styles.body}>
          ...
          <p className={styles.body}>
          Alternative tests such as IgG, Vega testing, iridology, hair analysis, kinesiology or cytotoxic testing are widely available at a cost, but none of these methods have any scientific evidence for their use and can’t diagnose an allergy or intolerance.          </p>

          <h2 className={styles.sectionTitle}>Should I try giving my baby a dairy free diet without a confirmed diagnosis?</h2>
          <img src={`${articlePath}/no-confirmed-diagnosis.jpg`} alt="Toddler eating broccoli" className="mt-[20px] w-full" />
          <p className={styles.body}>
          ...
          <img src={`${articlePath}/weaning-milk-allergy.jpg`} alt="Baby weaning with fruit" className="mt-[20px] w-full" />
          <p className={styles.body}>
          ...
          <h3 className={styles.allergenTitle}>Top allergenic foods include:</h3>
          ...
          <p className={styles.body}>
            It&apos;s very important not to delay the introduction of these foods. Research tells us that there is a critical window for desensitising your baby to high-risk foods and that these foods must be given between 6 and 12 months to reduce future risk. In fact, there are{" "}
            <a href="https://www.bsaci.org/about/early-feeding-guidance" target="_blank" rel="noopener" className={styles.link}>
              guidelines
            </a>{" "}
            to suggest this should be as early as four months in babies with severe eczema, but the decision to do this needs to be made by an allergy doctor.
          </p>
          <p className={styles.body}>
       ...
       <DairyFreeFaqAccordion items={faqItems} />
          ...
          <p className={styles.contactText}>
            ...
            <a href="https://childrensnutrition.co.uk/" target="_blank" rel="noopener" className={styles.link}>
