      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={`${styles.body} mt-0!`}>
            Getting your child to eat anything you put in front of them is a
            serious feat. Not to mention the added worry of them reaching their
            recommended vitamin intake. However, fret not, hitting nutritional
            targets can be as easy Vitamins A, B, C…and D.
          </p>

          <p className={styles.body}>
            While many parents may know that Vitamin D and Calcium are important
            for children&apos;s development, few are aware that they work most
            effectively when consumed together. Did you know, Vitamin D&apos;s
            role in calcium absorption helps our little ones avoid brittle
            bones, weak muscles, and impaired nerves?
            <sup>[1]</sup>
          </p>

          <p className={styles.body}>
            But why do we need calcium? Well, it helps build and maintain
            healthy bones and supports various bodily functions such as blood
            clotting and muscle contraction. Superstar Vitamin D also plays a
            big role in our bone health, by promoting bone growth and strength,
            and helping calcium to work its magic. However, unfortunately for us
            in Blighty, the main source of Vitamin D is from the sun, which
            means it&apos;s crucial we get it via our diets or supplements.
          </p>

          <p className={styles.body}>
            There is a reason it&apos;s called the &quot;sunshine vitamin&quot;
            after all!
          </p>

          <p className={styles.body}>
            Fortunately, there are many food sources containing Vitamin D,
            including egg yolks, fatty-fish and fortified milk and cereals. And
            we all know that calcium can be found in dairy, tofu, soybeans, and
            many leafy vegetables to name but a few.
          </p>

          <p className={styles.body}>
            It&apos;s all very well knowing where to find the vitamins, but most
            parents would agree that getting your child to eat them is the
            challenging part. This is where I&apos;m here to help! I&apos;ve
            partnered with Warburtons to develop some delicious and nutritious
            recipes to help your little one grow strong and healthy bones. Check
            out my three delicious, lunch-box friendly recipes below. I&apos;ve
            also popped a few ideas below on Vitamin D and calcium food sources
            that you can refer back to for inspiration.
          </p>
