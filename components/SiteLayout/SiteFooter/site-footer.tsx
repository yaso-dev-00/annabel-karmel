        ...
        <div className="site-footer-shell md:mt-[0px]! md:pt-[100px]!">
          <section className="footer-top">
            <Link
              ...
              href="/"
              aria-label="Annabel Karmel home"
            >
            ...
            <div className="footer-link-columns" aria-label="Footer links">
              <ul className="md:gap-y-0!">
                <li className="">
                  <a href="/about-annabel-karmel" className="p-0!">
                    About Annabel <br className="max-[900px]:hidden" /> Karmel
                  </a>
                </li>
            ...
            <article className="footer-app-cta flex flex-col gap-y-2 text-[#D79CAC]!">
              ...
              <p className="text-base !text-[#636262]">
                Discover nutritious recipes and expert meal planning tools for
                the whole family.
              </p>
              <div className="footer-store-links">
                <a
                  href={`${recipeAppPath}/download/ios`}
                  aria-label="Download on the App Store"
                  className="footer-store-badge"
                >
                  <img
                    src="/Download-Apple-Store.svg"
                    alt="Download on the App Store"
                  />
                </a>
                <a
                  href={`${recipeAppPath}/download/android`}
          ...
          <section className="footer-newsletter md:mt-[0px]!">
            <h2 className="text-[24px]! font-[400]! mb-[20px]! text-[#B34769]!">
            ...
            <form>
              ...
              <button
                type="submit"
                className="text-[17px]! h-[40px]! cursor-pointer md:h-[30px]! md:text-[16px]!"
              >
                Subscribe
              </button>
            </form>
