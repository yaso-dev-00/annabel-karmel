...
const indexBySlug = new Map(
  articleIndex.map((article) => [article.slug, article]),
);
...
const hrefAliases: Record<string, string> = {
  ...
  'food-allergies-natashas-law-put-a-label-on-it':
  ...
  'travelling-children-food-allergies':
...
export function enrichListingArticle<T extends ListingArticleFields>(
  article: T,
): T {
