      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[14px] pb-[54px] pt-[30px]">
          ...
          <p className={`${styles.lead} mb-4 mt-9!`}>
            ...
            nutrients in your baby&apos;s diet - especially that last meal of the day - can gently support better sleep.
          </p>
          <p className={`${styles.leadStrong} mb-3 mt-9! text-[#3a3a3a]! text-[22px]!`}>
          ...
          <div className="my-[22px] mb-[30px] mt-15!">
            <img src="/articles/best-foods-to-help-your-baby-sleep/hero.png" alt="Sleeping baby" />
          </div>
          ...
          <p className={`${styles.bodyText} mb-[100px]`}>
            Bananas are rich in magnesium and potassium - both natural muscle relaxants. They also contain
            tryptophan, which the body uses to make serotonin and melatonin, the hormones that promote sleep. A
            mashed banana with a little full-fat Greek yoghurt makes a perfect pre-bedtime pud.
          </p>
          ...
          <p className={`${styles.bodyText} mb-[44px]`}>
            Oats aren&apos;t just for breakfast! They contain melatonin and complex carbs that help more tryptophan get
            into baby&apos;s brain. A warm bowl of porridge can offer some comfort for babies from 6 months. Add spoonful
            fruit puree and nut butter for added flavour and nutrition.
          </p>
          <div className="my-[22px]  mb-[100px]">
            <img src="/articles/best-foods-to-help-your-baby-sleep/purple-porridge.png" alt="Purple porridge" />
          </div>
          ...
          <p className={`${styles.bodyText} mb-[100px]`}>
            From 6 months, not only is turkey or chicken is a great source of protein, it also contains tryptophan,
            which the body converts to calming serotonin. Pair with sweet potato for a simple, sleep-friendly supper.
            Or for those babies having finger foods, try making your own mini turkey balls or burgers served with
            sweet potato wedges.
          </p>
          ...
          <p className={`${styles.bodyText} mb-[44px]`}>
            A brilliant choice for baby&apos;s dinner, sweet potatoes are packed with beta-carotene and provide a gentle,
            steady release of energy through the night - ideal for avoiding hunger-induced wake-ups. Simply mash,
            blend into veggie-rich purees or serve as steamed or roasted wedges.
          </p>
          <div className="my-[22px] mb-[100px]">
            <img src="/articles/best-foods-to-help-your-baby-sleep/sweet-potato.png" alt="Sweet potato wedges" />
          </div>
          ...
          <p className={`${styles.bodyText} mb-[100px]`}>
            Full-fat dairy products like cheese or plain yoghurt contain calcium, which helps the brain use
            tryptophan to make melatonin. A few teaspoons of plain or Greek yoghurt after dinner can hit just the
            (sleepy) spot!
          </p>
          ...
          <p className={`${styles.bodyText} mb-[100px]`}>
            This fruit is a natural source of melatonin. Blend fresh cherries (or you can get frozen if they aren&apos;t
            in season) and stir into porridge or yoghurt to offer a gentle sleep aid.
          </p>
          ...
          <p className={`${styles.bodyText} mb-[44px]`}>
            Salmon is one of the best sources of the long-chain omega-3 fatty acids EPA and DHA. Not only do these
            essential fatty acids play a critical role in your baby&apos;s brain and visual development, but research has
            found that DHA also increases serotonin levels which could help your baby to nod-off naturally.
          </p>
          <div className="my-[22px] mb-[100px]">
            <img src="/articles/best-foods-to-help-your-baby-sleep/salmon.png" alt="Salmon baby meal" />
          </div>
          ...
          <p className={`${styles.bodyText} mb-[44px] mb-[100px]`}>
            We all know the importance of including those power-packed leafy green veggies in our little one&apos;s diets.
            The bonus is that dark leafy greens such as spinach are also high in tryptophan and magnesium which plays
            a role in calming the nervous system and regulating sleep.
          </p>
          ...
          <div className="mb-7 mt-[30px] bg-[#f0e4e4] px-[14px] pb-[14px] pt-14! md:pb-[10px]!">
            ...
            <p className={`${styles.bodyText} mb-[44px]`}>
              Avoid sugar and stimulating snacks too close to bed - even natural sugars can be energising close to
              sleep time.
            </p>
          </div>

        <div className="p-2 md:p-6 ">
        <h2 className={`${styles.tipsTitle} mb-5 text-center text-[#3a3a3a]!  text-[40px]! md:text-[42px]!`}>
            Top sleep tips from Natalie Barnett, VP of Clinical Research at Nanit
          </h2>
        </div>

          <h3 className={`${styles.subTitle} mb-6! text-[#3a3a3a]! text-[40px]! md:text-[42px]!`}>
            Pre-weaning babies
          </h3>
          ...
          <div className="my-[22px] mb-[60px]">
            <img src="/articles/best-foods-to-help-your-baby-sleep/sleeping-baby-2.png" alt="Baby drinking milk" />
          </div>
          ...
          <p className={`${styles.bodyText} mb-[35px]!`}>
            ...
            <br />
            Gas, reflux or sensitivities can interrupt sleep. If baby seems uncomfortable, speak to your GP - and
            remember, night waking isn&apos;t always hunger.
          </p>
          <p className={`${styles.bodyText} mb-[35px]!`}>
            <strong>Night waking isn&apos;t always about food</strong>
            <br />
            From around 4-6 months, many babies wake out of habit or for comfort. Respond gently, and if it&apos;s right
            for your baby, gradually reduce night feeds to encourage longer stretches of sleep.
          </p>
          <p className={`${styles.bodyText} mt-[14px]`}>
            Every baby is different. Sleep patterns shift with age, teething, growth spurts, and changes in routine.
            But nourishing your little one with the right foods can gently support their natural rhythms - and give
          ...
          <section className="relative left-1/2 right-1/2 mt-[100px] flex w-screen -translate-x-1/2 flex-col items-center px-2 md:px-4">
            <h1 className={`${styles.relatedTitle} text-[#3a3a3a]! text-[42px]! font-[430]`} >
              Related Articles
            </h1>
            <p className={`${styles.relatedIntro} mb-[14px]  mt-[20px]! text-[#3a3a3a]! text-[17px]! md:text-[22px]! text-center!`}>
