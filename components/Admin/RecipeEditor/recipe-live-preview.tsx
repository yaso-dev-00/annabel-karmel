...
const RecipePagePreview = memo(function RecipePagePreview({ recipe }: { recipe: Recipe }) {
...
export const RecipeLivePreview = forwardRef<PreviewViewportHandle, RecipeLivePreviewProps>(
