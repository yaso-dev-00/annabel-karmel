      ...
      <main className="overflow-x-hidden bg-white">
        <article className="mx-auto mt-[20px] w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.bodyFirst}>
            Baby-led weaning has never been more popular, yet, as a new parent,
            you wonder if self-feeding over spoon-fed weaning is the best choice
            for you and your baby.
          </p>
          <p className={styles.body}>
            With baby groups, parenting forums, friendship circles and experts
            banding around the merits of letting a child feed themselves from
            the very start of weaning, trusted feeding expert Annabel Karmel
          ...
          />
          <p className={styles.body}>
            Babies are naturally inquisitive – they are programmed to experiment
            and explore. It&apos;s how they learn. Self-feeding encourages
            hand-eye coordination and regularly handling foods improves their
            dexterity – all important skills for their future.
          </p>
          ...
          <p className={styles.bookClosing}>
            Annabel&apos;s{' '}
            <a
              href={BLW_RECIPE_BOOK_URL}
              target="_blank"
              rel="noopener noreferrer"
            >
              Baby-Led Weaning Recipe Book
            </a>{' '}
            equips families with the option to do what they feel is best. This
            book can be used on its own for exclusive baby-led weaning. Or it
            can be used as a companion cookbook to Annabel&apos;s original
            feeding guide, the{' '}
            <a
              href={MEAL_PLANNER_URL}
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <p className={styles.bookClosing}>
            As well as being packed with useful advice and top tips, the book is
            filled with 120 recipes which the whole family can enjoy together –
            from breakfast and snacks, to vegetables, poultry, fish, meat and
            more.
          </p>
