...
export const nuggetsPageData: PlantPoweredBitesPageData = {
  ...
  hero: {
    ...
    intro:
      'Expect spontaneous happy dances at the table with my plant-powered nuggets!',
    desktopWidth: 1320,
    desktopHeight: 1032,
    mobileWidth: 1320,
    mobileHeight: 1032,
  ...
  carousel: [
    {
      ...
      alt: 'Nuggets carousel 1',
      width: 800,
      height: 800,
    },
    {
      src: `${assetBase}/carousel-2.png`,
      alt: 'Nuggets carousel 5',
      width: 800,
      height: 800,
    },
    {
      src: `${assetBase}/carousel-3.png`,
      alt: 'Nuggets carousel 2',
      width: 800,
      height: 800,
    },
    {
      src: `${assetBase}/carousel-4.png`,
      alt: 'Nuggets carousel 6',
      width: 800,
      height: 800,
    },
    {
      src: `${assetBase}/carousel-5.png`,
      alt: 'Nuggets carousel 3',
      width: 800,
      height: 800,
    },
  ],
