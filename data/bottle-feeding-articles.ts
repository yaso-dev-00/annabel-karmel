...
export const bottleFeedingArticles: Record<string, BreastfeedingArticle> = {
  "paced-bottle-feeding": {
    metaTitle: "Paced Bottle Feeding | Formula | Breast | Milk | Annabel Karmel",
    metaDescription:
    ...
    blocks: [
      ...
      },
      {
        ...
        content: [
          ". Visit ",
          { text: "@milkmakingmama", href: "https://www.instagram.com/milkmakingmama/" },
      ...
      },
      {
        ...
        content: [
          ...
          { text: "Responsive Bottle Feeding", href: "/advice/responsive-bottle-feeding" },
          ".",
        ],
      }
    ],
  ...
  "responsive-bottle-feeding": {
    metaTitle: "Responsive Bottle Feeding | Bottle Feeding Tips | Annabel Karmel",
    metaDescription:
    ...
    blocks: [
      ...
      },
      {
        ...
        content: [
          ...
          { text: "paced bottle feeding", href: "/advice/paced-bottle-feeding" },
  ...
  "how-to-sterilise-bottles": {
    metaTitle: "How to sterilise bottles | Bottle Feeding Tips | Annabel Karmel",
    metaDescription:
    ...
    blocks: [
      ...
      { type: "heading", text: "Steam sterilising (electric steriliser or microwave)" },
      {
        type: "list",
        items: [
  ...
  "different-infant-formula-milks": {
    metaTitle: "The different infant formula milks | Bottle Feeding Tips | Annabel Karmel",
    metaDescription:
    ...
    blocks: [
      ...
      { type: "heading", text: "Protecting Your Baby from Eczema and Allergies" },
      {
        type: "image",
