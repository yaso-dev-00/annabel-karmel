...
export function RecipeAppPricingSection() {
  ...
  return (
    <section
      ...
      aria-labelledby="recipe-app-pricing-heading"
    >
        ...
        <div className={styles.pricingCardWrap}>
          <div className={styles.pricingCard}>
            <div className={styles.pricingToggle}>
              <span
                className={!yearly ? styles.pricingToggleActive : undefined}
              >
                Monthly
              </span>
              ...
              <span className={yearly ? styles.pricingToggleActive : undefined}>
                Yearly
              </span>
            </div>
            <p className={styles.pricingPrice}>
              {yearly
                ? recipeAppPricing.yearlyPrice
                : recipeAppPricing.monthlyPrice}
            </p>
            <p className={styles.pricingTrialNote}>
              {recipeAppPricing.trialNote}
            </p>
            <p className={styles.pricingCancelNote}>
              {recipeAppPricing.cancelNote}
            </p>
          </div>
        </div>
      </div>
