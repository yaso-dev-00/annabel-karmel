...
export const childcareAwards = [
  { src: `${sharedBase}/awards/platinum-logo.png`, alt: "Tried and Tested Platinum award", width: 2080, height: 2560 },
  { src: `${sharedBase}/awards/best-family-app.png`, alt: "Best Family App 2026 award", width: 1839, height: 2560 },
  { src: `${sharedBase}/awards/absolutely-mama.png`, alt: "Absolutely Mama Gold 2024 award", width: 300, height: 320 },
  { src: `${sharedBase}/awards/pregnancy-baby-fair.png`, alt: "Pregnancy Baby Fair 2024 award", width: 300, height: 320 },
  { src: `${sharedBase}/awards/first-time-mums.png`, alt: "First Time Mums Awards logo", width: 300, height: 320 },
  { src: `${sharedBase}/awards/mum-marketplace.jpeg`, alt: "Mum Marketplace 2026 award", width: 836, height: 879 },
];
...
export const childcareRecipeCategories = [
  { label: "First foods", image: `${sharedBase}/recipes/first-foods.jpg`, width: recipeImageSize, height: recipeImageSize },
  { label: "6-9 months", image: `${sharedBase}/recipes/6-9-months.jpg`, width: recipeImageSize, height: recipeImageSize },
  { label: "9-12 months", image: `${sharedBase}/recipes/9-12-months.jpg`, width: recipeImageSize, height: recipeImageSize },
  { label: "12-18 months", image: `${sharedBase}/recipes/12-18-months.jpg`, width: recipeImageSize, height: recipeImageSize },
  { label: "Finger foods", image: `${sharedBase}/recipes/finger-foods.jpg`, width: recipeImageSize, height: recipeImageSize },
  { label: "Toddler", image: `${sharedBase}/recipes/toddler.jpg`, width: recipeImageSize, height: recipeImageSize },
  { label: "Snacks", image: `${sharedBase}/recipes/snacks.jpg`, width: recipeImageSize, height: recipeImageSize },
  { label: "Lunchboxes", image: `${sharedBase}/recipes/lunchboxes.jpg`, width: recipeImageSize, height: recipeImageSize },
  { label: "Family meals", image: `${sharedBase}/recipes/family-meals.jpg`, width: recipeImageSize, height: recipeImageSize },
  { label: "Breakfast", image: `${sharedBase}/recipes/breakfast.jpg`, width: recipeImageSize, height: recipeImageSize },
  { label: "Allergies", image: `${sharedBase}/recipes/allergies.jpg`, width: recipeImageSize, height: recipeImageSize },
  { label: "Vegetarian", image: `${sharedBase}/recipes/vegetarian.jpg`, width: recipeImageSize, height: recipeImageSize },
];
