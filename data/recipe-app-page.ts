...
export const recipeAppLinks = {
  appStore: "https://apps.apple.com/us/app/baby-toddler-recipe-app/id409157308?platform=iphone",
  playStore: "https://play.google.com/store/apps/details?id=com.applikation.annabelkarmel&hl=en&gl=US",
...
export const recipeAppAwards = [
  { src: `${assetBase}/awards/platinum-logo.png`, alt: "Tried and Tested Platinum award", width: 2080, height: 2560 },
  { src: `${assetBase}/awards/mama-awards-2024.png`, alt: "Mother & Baby Awards 2024", width: 207, height: 199 },
  { src: `${assetBase}/awards/best-family-app.png`, alt: "Best Family App 2026 award", width: 1839, height: 2560 },
  { src: `${assetBase}/awards/product-silver.png`, alt: "Product silver award", width: 157, height: 211 },
  { src: `${assetBase}/awards/mum-marketplace.jpeg`, alt: "Mum Marketplace 2026 award", width: 836, height: 879 },
  { src: `${assetBase}/awards/best-2024.png`, alt: "Best 2024 award", width: 201, height: 209 },
];
...
export const recipeAppCategories = [
  { label: "First foods", image: `${assetBase}/recipes/first-foods.jpg`, width: recipeThumb, height: recipeThumb },
  { label: "6-9 months", image: `${assetBase}/recipes/6-9-months.jpg`, width: recipeThumb, height: recipeThumb },
  { label: "9-12 months", image: `${assetBase}/recipes/9-12-months.jpg`, width: recipeThumb, height: recipeThumb },
  { label: "12-18 months", image: `${assetBase}/recipes/12-18-months.jpg`, width: recipeThumb, height: recipeThumb },
  { label: "Finger foods", image: `${assetBase}/recipes/finger-foods.jpg`, width: recipeThumb, height: recipeThumb },
  { label: "Toddler", image: `${assetBase}/recipes/toddler.jpg`, width: recipeThumb, height: recipeThumb },
  { label: "Snacks", image: `${assetBase}/recipes/snacks.jpg`, width: recipeThumb, height: recipeThumb },
  { label: "Lunchboxes", image: `${assetBase}/recipes/lunchboxes.jpg`, width: recipeThumb, height: recipeThumb },
  { label: "Family meals", image: `${assetBase}/recipes/family-meals.jpg`, width: recipeThumb, height: recipeThumb },
  { label: "Breakfast", image: `${assetBase}/recipes/breakfast.jpg`, width: recipeThumb, height: recipeThumb },
  { label: "Allergies", image: `${assetBase}/recipes/allergies.jpg`, width: recipeThumb, height: recipeThumb },
  { label: "Vegetarian", image: `${assetBase}/recipes/vegetarian.jpg`, width: recipeThumb, height: recipeThumb },
];
...
export const recipeAppTestimonials = [
  ...
  {
    quote: "The 15 min meals are just amazing, absolute life saver and the kids love them",
    name: "cmz1981",
  },
];
