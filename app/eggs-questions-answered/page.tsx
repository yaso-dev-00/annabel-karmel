...
const accordionItems = [
  ...
  {
    title:
      "My baby is really fussy, and she won't eat boiled or scrambled eggs. How can I get her to eat egg?",
    paragraphs: [
      ...
      <main className="bg-white">
        <article className="mx-auto mt-[48px] w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          ...
          <p className={styles.intro}>
            <strong>
              Eggs rule. They are quick to cook and full of essential vitamins
              and minerals. Babies can also now eat them runny, as long as they
              are British Lion eggs, due to a change in Government advice in
              2017, which means there are even more ways to enjoy this scrummy
              superfood.
            </strong>
          </p>

          <p className={`${styles.body} mt-[40px]! pb-[30px]!`}>
            But you still have some concerns over giving eggs to babies, so
            we've teamed up with dietitian Dr Carrie Ruxton to answer your
            questions and crack your concerns.
          </p>
