...
export const articleSlug = 'busting-common-baby-sleep-myths';
export const articlePath = `/articles/${articleSlug}`;

export const bustingCommonBabySleepMythsSections: SleepAdviceSection[] = [
  {
  ...
  },
  {
    ...
    image: `${articlePath}/myth-1.jpg`,
    imageAlt: 'Baby sleeping peacefully',
    imageFirst: true,
    paragraphs: [
  ...
  {
    title: 'Myth #2: Your baby is waking up at night because they are hungry.',
    image: `${articlePath}/myth-2.jpg`,
  ...
  },
  {
    ...
    image: `${articlePath}/myth-3.jpg`,
    imageAlt: 'Baby sleeping after a feed',
    imageFirst: true,
    paragraphs: [
  ...
  },
  {
    ...
    image: `${articlePath}/myth-4.png`,
    imageAlt: 'Baby napping during the day',
    imageFirst: true,
    paragraphs: [
  ...
  },
  {
    ...
    image: `${articlePath}/myth-5.jpg`,
    imageAlt: 'Parent comforting baby at bedtime',
    imageFirst: true,
    paragraphs: [
  ...
  {
    title: 'Myth #6: Your baby should be in bed by 7pm.',
    image: `${articlePath}/myth-6.jpg`,
    imageAlt: 'Baby bedtime routine',
    imageFirst: true,
    paragraphs: [
  ...
  },
  {
    ...
    image: `${articlePath}/myth-7.jpg`,
    imageAlt: 'Baby sleeping peacefully without sleep training',
    imageFirst: true,
    paragraphs: [
  ...
  {
    title: 'Myth #8: Your baby should want to sleep when it gets dark.',
    image: `${articlePath}/myth-8.jpg`,
    imageAlt: 'Newborn baby sleeping',
    imageFirst: true,
    paragraphs: [
...
export const bustingCommonBabySleepMythsRelatedArticles =
