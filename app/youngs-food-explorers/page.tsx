      ...
      <main className="overflow-x-hidden bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[30px] md:px-[14px]">
          ...
          <h1 className={styles.heroTitle}>
            LET&apos;S GET THE WHOLE FAMILY EXPLORING FISH!
          </h1>
          ...
          <p className={styles.body}>
            If you&apos;re looking for more ways to pack in those all-important
            two portions of fish a week, you&apos;ve come to the right place!
          </p>
          <p className={styles.body}>
            We all know that seafood is packed with lots of vitamins and
            minerals that the body needs to function properly. Yet getting kids
            to eat fish can be easier said than done. In this article we will
            run through some tricks, tips and great recipes to get your tots
            diving into fish dinners!
          </p>
          <p className={styles.body}>
            The secret to getting kids to eat fish is to keep things simple, but
            add a splash of creativity so that your little ones will love to get
            involved.
          </p>
          <p className={styles.body}>
            And to help inspire you this Autumn, we&apos;ve teamed up with
            Young&apos;s Seafood to serve-up some fun ideas to get the whole
            family hooked.
          </p>

          {/* Bold recipe section intro */}
          <p className={styles.bodyBold}>
            Let&apos;s face it, kids eat with their eyes, so getting kids to eat
            fish can be as simple as presentation. Here are some easy ideas to
            explore, and don&apos;t forget to involve even the smallest of
            shipmates in the food prep!
          </p>
          ...
          <div className="mt-[60px] space-y-[56px]">
            ...
            <div className="flex flex-col gap-[28px] md:flex-row md:items-center md:gap-[48px]">
              <div className="md:w-1/2">
                ...
                <p className={styles.nutritionBody}>
                  Seafood is a great source of protein. A portion of seafood
                  typically provides you with around half of your protein
                  requirement for the day.
                </p>
                <p className={styles.nutritionBody}>
                  Why do we need protein? It&apos;s essential for the growth and
                  maintenance of muscles and body tissues.
                </p>
              </div>
              <div className="md:w-1/2">
                <img
            ...
            <div className="flex flex-col gap-[28px] md:flex-row-reverse md:items-center md:gap-[48px]">
              <div className="md:w-1/2">
                ...
                <p className={styles.nutritionBody}>
                  We all need some fat in our diet, but too much saturated fat
                  can raise cholesterol, increasing the risk of heart disease.
                </p>
                <p className={styles.nutritionBody}>
                  Seafood is generally lower in saturated fat than other
                  proteins, especially when grilled, baked, poached or steamed.
                </p>
              </div>
              <div className="md:w-1/2">
                <img
            ...
            <div className="flex flex-col gap-[28px] md:flex-row md:items-center md:gap-[48px]">
              <div className="md:w-1/2">
                ...
                <p className={styles.nutritionBody}>
                  We should be eating at least two portions (a portion is around
                  140g) of fish per week, one of which should be an oily fish
                  such as salmon, mackerel, or sardines.
                </p>
                <p className={styles.nutritionBody}>
                  These provide the long chain omega-3 fatty acids which have
                  important healthy benefits such as helping with brain
                  development and keeping a healthy heart. Which is why getting
                  kids to eat fish is so important!
                </p>
              </div>
              <div className="md:w-1/2">
                <img
          ...
          <div className="mt-[60px] grid grid-cols-1 gap-[24px] md:grid-cols-2">
            <div className={`${styles.tipCard} flex flex-col`}>
              ...
              <div className="flex flex-col flex-1 p-[20px]">
                ...
                <p className={styles.tipBody}>
                  Check out Annabel&apos;s tricks to help you and your kids
                  enjoy cooking together. Aprons at the ready!
                </p>
                <a
            ...
            <div className={`${styles.tipCard} flex flex-col`}>
              ...
              <div className="flex flex-col flex-1 p-[20px]">
                ...
                <p className={styles.tipBody}>
                  Fish doesn&apos;t have to be a hard sell to mini diners. Try
                  these simple hacks for packing in their 2-a-week.
                </p>
                <a
