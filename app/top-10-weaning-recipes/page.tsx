      ...
      <main className="overflow-x-hidden bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.intro}>
            Reaching that all important milestone of weaning your baby is a key moment for every parent. It's exciting
            and full of fun, but it can also be a little daunting. Fear not! Annabel's got you covered with her top
            weaning recipes to help you and your little one get started on your weaning adventure!
          </p>
          <p className={styles.intro}>
            Don't forget to visit{" "}
            <a href="https://www.annabelkarmel.com/weaning-hub/" className={styles.link} target="_blank" rel="noopener noreferrer">
              Annabel's Weaning Hub
            </a>{" "}
            for advice, handy tips, recipes and product recommendations. With all the information you need in one place
            covering every stage of your baby's weaning journey, it's your go-to guide to baby's first year.
          </p>

          <div className="space-y-[60px]">
            {recipes.map((recipe) => (
              <section key={recipe.title} className={`${styles.card} mt-[40px]`}>
