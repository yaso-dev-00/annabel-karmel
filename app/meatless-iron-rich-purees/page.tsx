      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} md:text-left text-center`}>
            ...
            to introduce to your baby from six months.
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            Getting enough iron for babies is essential as it is needed for
            making haemoglobin in red blood cells. It’s the micronutrient that
            enables the blood to carry oxygen around the body to your baby’s
            organs and muscles. It’s also important for the immune system – so
            as you can see it is vital for your baby.
          </p>
          <p className={`${styles.intro} md:text-left text-center`}>
            Full term babies are born with a reserve of iron. Until six months,
            your baby will have been using the store of iron they’ve inherited
            from mum. But it’ll be starting to run low by this point, which is
            why from around six months is the ideal time to start introducing
          ...
          <p className={`${styles.intro} mt-[30px]! md:text-left text-center `}>
            {' '}
            Here are some of my favourite Meatless Iron Rich Puree Combos for
            you to try:
          </p>
