...
export type MildChickenTikkaAccordionItem = (typeof mildChickenTikkaPageData.accordion)[number];
export type MildChickenTikkaRelatedProduct = (typeof mildChickenTikkaPageData.related)[number];
