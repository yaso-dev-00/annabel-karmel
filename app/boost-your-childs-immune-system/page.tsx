...
const sections = [
  ...
  },
  {
    ...
    image:
      '/articles/boost-your-childs-immune-system/vitamin-c-for-the-win.jpg',
  ...
  },
  {
    ...
    image:
      '/articles/get-your-free-top-50-first-foods-list/related-haunted-toast.png',
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.body}>
            If there's anything that we've learnt from the past two years, it's
            that we can't underestimate the importance of a strong and healthy
            immune system. Nutritional deficiencies can make us more susceptible
            to viruses, so eating well is paramount when building a robust and
              ...
              <section key={section.title}>
                ...
                <div className="flex justify-center w-full">
                  <img
                    src={section.image}
                    alt={section.alt}
                    className="mt-[30px] w-full md:max-w-[850px]!"
                  />
                </div>
                {section.caption ? (
                  <p className={`${styles.caption} mt-[8px]`}>
                    {section.caption}
                  </p>
                ) : null}
                <p className={`${styles.body} mt-[14px]`}>{section.body}</p>
                <p
                  className={`${styles.recipeLink} mt-[14px] hover:var(--hover-color)!`}
                >
