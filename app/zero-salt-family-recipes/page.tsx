...
const recipes = [
  ...
  },
  {
    ...
    image:
      '/articles/zero-salt-family-recipes/vegetable-risotto-arancini-balls.jpg',
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro} text-center`}>
            I've teamed up with Knorr to launch #KnorrFamilyFlavours using their
            history-making #KnorrZeroSalt range of stock cubes. These pioneering
            stock cubes have all the flavour but no added salt.
          </p>
          <p className={`${styles.intro} text-center`}>
            Whether you're a dab hand or just aspiring to do more scratch
            cooking, you'll know that Knorr's stock cubes are a kitchen staple.
            But as delicious, nutritious, and necessary that stock cubes are,
            added salt can be problematic for your family.
          </p>
          <p className={`${styles.intro} text-center`}>
            Knorr has worked hard to develop the perfect blend of herbs and
            spices without you having to worry about your family's sodium intake
            and I'm delighted to incorporate them into these delicious recipes!
          </p>
          <p className={`${styles.intro} text-center`}>
