...
export const articleSlug = "pregnancy-month-month";
export const articlePath = `/articles/${articleSlug}`;

export const pregnancyIntroParagraphs = [
  "A typical pregnancy lasts between 37 and 42 weeks from the first day of your last period up to the day your baby is born. Now is the time to get prepared to discuss everything in 'weeks' but don't worry as these will be further broken down into stages of pregnancy called trimesters.",
...
export const pregnancyTrimesterAccordionItems: EggQuestionItem[] = [
  {
    title: "First Trimester: Week 1 (conception) – Week 12",
    paragraphs: [
  ...
  {
    title: "Third Trimester: Week 29 – Week 40 (birth)",
    paragraphs: [
...
export const pregnancyMonthRelatedArticles: RelatedArticleItem[] = [
  {
