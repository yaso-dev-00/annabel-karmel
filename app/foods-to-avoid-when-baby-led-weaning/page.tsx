      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.intro}>
            Baby-led weaning (BLW) is a great opportunity to introduce your baby
            to a variety of tastes and textures. And while when it comes to BLW
            the old saying that &apos;variety is key&apos; rings true, there are
            some foods that are best to leave off the menu for babies under 12
            months. So, what foods should you avoid when baby led weaning?
          </p>
          ...
          <p className={styles.bodyText}>
            Your baby should never be left alone while eating, and they must
            always be supported in an upright position.
          </p>
          <p className={styles.bodyText}>
            <strong>Top Tip:</strong> Babies can store food in their cheeks for
            quite some time after eating, so remember to check that all food has
            been swallowed.
          </p>
          <p className={styles.bodyText}>
            <strong>And Remember: </strong> Baby-led weaning doesn&apos;t have
            to be an all-or-nothing method. You can choose to feed your baby
            soft finger foods and small portions of family meals alongside
            spoon-feeding purees. The most important thing is that both you and
            your baby feel content and comfortable in your routine.
          </p>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className={styles.bookPromoText}>
                ...
                supports families as their little one weans. This book can be
                used on its own for exclusive baby-led weaning or as a companion
                cookbook to Annabel&apos;s original feeding guide, the{' '}
                <a
