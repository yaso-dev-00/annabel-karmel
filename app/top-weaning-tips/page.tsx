      ...
      <main className="overflow-x-hidden bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[10px] pt-[20px] md:px-[14px] md:pt-[28px]">
          <p className={styles.intro}>
            ...
            opportunity to bond – and it can be quite the fun adventure too!
          </p>
          ...
          <h2 className={styles.sectionHeading}>Here are my top weaning tips:</h2>
          ...
          <p className={styles.fingerFoodsNote}>
            Once they have mastered purees, its time to graduate to finger foods. Learn more about{" "}
