...
const relatedArticles = getRelatedArticles(
  '/10-meals-you-can-make-with-leftovers',
);
...
const recipes = [
  ...
  },
  {
    ...
    image:
      '/articles/10-meals-you-can-make-with-leftovers/hidden-veg-chicken-sausages.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-meals-you-can-make-with-leftovers/roasted-vegetable-soup.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-meals-you-can-make-with-leftovers/banana-carrot-bread.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-meals-you-can-make-with-leftovers/veggie-packed-frittata-muffins.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-meals-you-can-make-with-leftovers/cheesy-broccoli-pasta.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-meals-you-can-make-with-leftovers/chicken-tomato-corn-fritters.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-meals-you-can-make-with-leftovers/salmon-veggie-bites.jpg',
    excerpt:
  ...
  },
  {
    ...
    image:
      '/articles/10-meals-you-can-make-with-leftovers/herby-chicken-nuggets.jpg',
    excerpt:
      ...
      <main className="bg-white">
        <article className="mx-auto w-full max-w-[1200px] px-[8px] pb-[14px] pt-[22px] md:px-[14px] md:pt-[30px]">
          <p className={`${styles.intro}  text-center`}>
            ...
            <strong>
              <a
                ...
                href="https://lovebakerstreet.com/food-waste/"
                target="_blank"
                rel="noreferrer"
              >
                Baker Street
            ...
            we're passionate about doing something about it. With the
            cost-of-living crisis surging on, there's no time like the present
            to take the steps to reduce waste, cut costs and help the
            environment!
          </p>
          <p className={`${styles.intro}  text-center`}>
            Don't let anything go to waste with our top 10 leftover recipes.
            Make use of your leftover bread with Annabel's delicious Strata
            recipe, use up leftover chicken to make satisfying pies or try our
            hidden veg & chicken sausages. We've also got tons of recipes to use
            up your leftover veggies, try Annabel's hidden veg tomato sauce or
            roasted veg soup.
          </p>
          <p className={`${styles.intro}  text-center`}>
            Without further ado, here are Annabel's top 10 recipes to rustle up
            a delicious family meal with just the leftover ingredients from your
            fridge and pantry.
          </p>
          <p className={`${styles.intro} text-center`}>
            For more top tips on how to maximise your leftovers and reduce food
            waste at home{' '}
            <em>
              <strong>
                <a
          ...
          <p className={`${styles.intro} mt-[24px]! text-center`}>
            Follow Baker Street{' '}
            <em>
              for more ways to use their cleverly packed range of products that
              last longer to help you and your family tackle food waste.
            </em>
          </p>
